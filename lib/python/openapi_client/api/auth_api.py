...
class AuthApi:
    ...
    @validate_arguments
    def group_edit_info(self, organisation_id : Annotated[StrictStr, Field(..., description="the main organisation (its guid id) to get users for")], session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], cm_group_edit_info : CMGroupEditInfo, **kwargs) -> CMGroupList:  # noqa: E501
        """Get Group edit information  # noqa: E501

        Return the information needed for the admin UX editing a group  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.group_edit_info(organisation_id, session_id, cm_group_edit_info, async_req=True)
        >>> result = thread.get()
        ...
        :param session_id: a valid SimSage Session id. (required)
        :type session_id: str
        :param cm_group_edit_info: (required)
        :type cm_group_edit_info: CMGroupEditInfo
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the group_edit_info_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.group_edit_info_with_http_info(organisation_id, session_id, cm_group_edit_info, **kwargs)  # noqa: E501

    @validate_arguments
    def group_edit_info_with_http_info(self, organisation_id : Annotated[StrictStr, Field(..., description="the main organisation (its guid id) to get users for")], session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], cm_group_edit_info : CMGroupEditInfo, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Group edit information  # noqa: E501
        ...
        >>> thread = api.group_edit_info_with_http_info(organisation_id, session_id, cm_group_edit_info, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method group_edit_info" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['cm_group_edit_info'] is not None:
            _body_params = _params['cm_group_edit_info']
        ...
        return self.api_client.call_api(
            '/api/auth/group-edit-info/{organisationId}', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def sign_in_admin_using_session_id(self, session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], **kwargs) -> SignInAdmin:  # noqa: E501
        """session-id Sign-in  # noqa: E501

        Sign-in a user using an existing session-id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sign_in_admin_using_session_id(session_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the sign_in_admin_using_session_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.sign_in_admin_using_session_id_with_http_info(session_id, **kwargs)  # noqa: E501

    @validate_arguments
    def sign_in_admin_using_session_id_with_http_info(self, session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], **kwargs) -> ApiResponse:  # noqa: E501
        """session-id Sign-in  # noqa: E501
        ...
        >>> thread = api.sign_in_admin_using_session_id_with_http_info(session_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sign_in_admin_using_session_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/auth/admin/authenticate/session-id', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
