...
class LanguageApi:
    ...
    @validate_arguments
    def truncate_slow_indexes(self, organisation_id : Annotated[StrictStr, Field(..., description="the organisation's id (a guid)")], kb_id : Annotated[StrictStr, Field(..., description="the knowledge-bases' id (a guid)")], session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], api_version : Optional[StrictStr] = None, **kwargs) -> JsonMessage:  # noqa: E501
        """Truncate slow Indexes  # noqa: E501

        Force slow-index truncation for a the given knowledge-base, now.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.truncate_slow_indexes(organisation_id, kb_id, session_id, api_version, async_req=True)
        >>> result = thread.get()

        :param organisation_id: the organisation's id (a guid) (required)
        :type organisation_id: str
        :param kb_id: the knowledge-bases' id (a guid) (required)
        :type kb_id: str
        :param session_id: a valid SimSage Session id. (required)
        :type session_id: str
        :param api_version:
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the truncate_slow_indexes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.truncate_slow_indexes_with_http_info(organisation_id, kb_id, session_id, api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def truncate_slow_indexes_with_http_info(self, organisation_id : Annotated[StrictStr, Field(..., description="the organisation's id (a guid)")], kb_id : Annotated[StrictStr, Field(..., description="the knowledge-bases' id (a guid)")], session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], api_version : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Truncate slow Indexes  # noqa: E501
        ...
        >>> thread = api.truncate_slow_indexes_with_http_info(organisation_id, kb_id, session_id, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method truncate_slow_indexes" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/language/truncate-slow-indexes/{organisationId}/{kbId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
