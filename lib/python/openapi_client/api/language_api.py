...
class LanguageApi:
    ...
    @validate_arguments
    def optimize_indexes_abort(self, session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], cm_optimize_index : CMOptimizeIndex, api_version : Optional[StrictStr] = None, **kwargs) -> JsonMessage:  # noqa: E501
        """Abort Index Optimization  # noqa: E501

        Force index optimizer to abort a job.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.optimize_indexes_abort(session_id, cm_optimize_index, api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the optimize_indexes_abort_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.optimize_indexes_abort_with_http_info(session_id, cm_optimize_index, api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def optimize_indexes_abort_with_http_info(self, session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], cm_optimize_index : CMOptimizeIndex, api_version : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Abort Index Optimization  # noqa: E501
        ...
        >>> thread = api.optimize_indexes_abort_with_http_info(session_id, cm_optimize_index, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method optimize_indexes_abort" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/language/optimize-indexes-abort', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
