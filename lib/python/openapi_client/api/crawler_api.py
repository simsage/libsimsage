...
class CrawlerApi:
    ...
    @validate_arguments
    def mark_crawl_as_delta_reset(self, cm_external_mark_reset_crawl : CMExternalMarkResetCrawl, api_version : Optional[StrictStr] = None, **kwargs) -> JsonMessage:  # noqa: E501
        """Update delta token  # noqa: E501

        An external crawler marks a source as delta reset required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.mark_crawl_as_delta_reset(cm_external_mark_reset_crawl, api_version, async_req=True)
        >>> result = thread.get()

        :param cm_external_mark_reset_crawl: (required)
        :type cm_external_mark_reset_crawl: CMExternalMarkResetCrawl
        :param api_version:
        :type api_version: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the mark_crawl_as_delta_reset_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.mark_crawl_as_delta_reset_with_http_info(cm_external_mark_reset_crawl, api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def mark_crawl_as_delta_reset_with_http_info(self, cm_external_mark_reset_crawl : CMExternalMarkResetCrawl, api_version : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update delta token  # noqa: E501
        ...
        >>> thread = api.mark_crawl_as_delta_reset_with_http_info(cm_external_mark_reset_crawl, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method mark_crawl_as_delta_reset" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['cm_external_mark_reset_crawl'] is not None:
            _body_params = _params['cm_external_mark_reset_crawl']
        ...
        return self.api_client.call_api(
            '/api/crawler/external/crawler/mark-as-reset', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def sync(self, session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], cm_sync_g_drive : CMSyncGDrive, **kwargs) -> object:  # noqa: E501
        """sync  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sync(session_id, cm_sync_g_drive, async_req=True)
        >>> result = thread.get()

        :param session_id: a valid SimSage Session id. (required)
        :type session_id: str
        :param cm_sync_g_drive: (required)
        :type cm_sync_g_drive: CMSyncGDrive
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.sync_with_http_info(session_id, cm_sync_g_drive, **kwargs)  # noqa: E501

    @validate_arguments
    def sync_with_http_info(self, session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], cm_sync_g_drive : CMSyncGDrive, **kwargs) -> ApiResponse:  # noqa: E501
        """sync  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sync_with_http_info(session_id, cm_sync_g_drive, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['cm_sync_g_drive'] is not None:
            _body_params = _params['cm_sync_g_drive']
        ...
        return self.api_client.call_api(
            '/api/crawler/syncgdrivegroups', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
