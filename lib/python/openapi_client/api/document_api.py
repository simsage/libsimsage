...
class DocumentApi:
    ...
    def preview_with_http_info(self, organisation_id : Annotated[StrictStr, Field(..., description="the organisation (its guid id)")], kb_id : Annotated[StrictStr, Field(..., description="the knowledge-base (its guid id)")], client_id : Annotated[StrictStr, Field(..., description="the client-id, a persistent id identifying the remote client making this request.")], session_id : Annotated[StrictStr, Field(..., description="the session-id, the security required for making this request.")], url_id : Annotated[StrictInt, Field(..., description="the SimSage id for this url")], page : Annotated[StrictInt, Field(..., description="what page to render")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        # set the HTTP header `Accept`
        _header_params['Accept'] = self.api_client.select_header_accept(
            ['image/jpeg', 'image/svg+xml', 'application/json'])  # noqa: E501
    ...
    @validate_arguments
    def zip_source(self, session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], cm_zip_source : CMZipSource, api_version : Optional[StrictStr] = None, **kwargs) -> JsonMessage:  # noqa: E501
        """Zip source documents  # noqa: E501

        Zip all documents in a source on the local server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.zip_source(session_id, cm_zip_source, api_version, async_req=True)
        >>> result = thread.get()

        :param session_id: a valid SimSage Session id. (required)
        :type session_id: str
        :param cm_zip_source: (required)
        :type cm_zip_source: CMZipSource
        :param api_version:
        :type api_version: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the zip_source_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.zip_source_with_http_info(session_id, cm_zip_source, api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def zip_source_with_http_info(self, session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], cm_zip_source : CMZipSource, api_version : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Zip source documents  # noqa: E501
        ...
        >>> thread = api.zip_source_with_http_info(session_id, cm_zip_source, api_version, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['cm_zip_source'] is not None:
            _body_params = _params['cm_zip_source']
