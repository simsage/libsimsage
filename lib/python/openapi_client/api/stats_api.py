...
class StatsApi:
    ...
    @validate_arguments
    def system_logs(self, organisation_id : Annotated[StrictStr, Field(..., description="the organisation (its guid id)")], service : Annotated[StrictStr, Field(..., description="the service to get the log for")], num_lines : Annotated[StrictInt, Field(..., description="the maximum number of lines to return if > 0")], session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], **kwargs) -> List[CMLoggerEntry]:  # noqa: E501
        ...
        >>> thread = api.system_logs(organisation_id, service, num_lines, session_id, async_req=True)
        >>> result = thread.get()
        ...
        :type service: str
        :param num_lines: the maximum number of lines to return if > 0 (required)
        :type num_lines: int
        :param session_id: a valid SimSage Session id. (required)
        :type session_id: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.system_logs_with_http_info(organisation_id, service, num_lines, session_id, **kwargs)  # noqa: E501
    ...
    def system_logs_with_http_info(self, organisation_id : Annotated[StrictStr, Field(..., description="the organisation (its guid id)")], service : Annotated[StrictStr, Field(..., description="the service to get the log for")], num_lines : Annotated[StrictInt, Field(..., description="the maximum number of lines to return if > 0")], session_id : Annotated[StrictStr, Field(..., description="a valid SimSage Session id.")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.system_logs_with_http_info(organisation_id, service, num_lines, session_id, async_req=True)
        >>> result = thread.get()
        ...
        if _params['num_lines']:
            _path_params['numLines'] = _params['num_lines']
        ...
        return self.api_client.call_api(
            '/api/stats/system-logs/{organisationId}/{service}/{numLines}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
