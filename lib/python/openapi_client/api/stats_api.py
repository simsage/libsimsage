...
class StatsApi:
    ...
    def get_index_optimzation_report(self, session_id : Annotated[StrictStr, Field(..., description="a valid session-guid id.")], organisation_id : Annotated[StrictStr, Field(..., description="the organisation (its guid id)")], kb_id : Annotated[StrictStr, Field(..., description="the knowledge-base (its guid id)")], id : Annotated[StrictInt, Field(..., description="the id of the report")], **kwargs) -> List[OptimizeIndexesGetReportCmd]:  # noqa: E501
        ...
        >>> thread = api.get_index_optimzation_report(session_id, organisation_id, kb_id, id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_index_optimzation_report_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_index_optimzation_report_with_http_info(session_id, organisation_id, kb_id, id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_index_optimzation_report_with_http_info(self, session_id : Annotated[StrictStr, Field(..., description="a valid session-guid id.")], organisation_id : Annotated[StrictStr, Field(..., description="the organisation (its guid id)")], kb_id : Annotated[StrictStr, Field(..., description="the knowledge-base (its guid id)")], id : Annotated[StrictInt, Field(..., description="the id of the report")], **kwargs) -> ApiResponse:  # noqa: E501
        """get an optimization report  # noqa: E501
        ...
        >>> thread = api.get_index_optimzation_report_with_http_info(session_id, organisation_id, kb_id, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_index_optimzation_report" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def get_index_optimzation_reports(self, session_id : Annotated[StrictStr, Field(..., description="a valid session-guid id.")], organisation_id : Annotated[StrictStr, Field(..., description="the organisation (its guid id)")], kb_id : Annotated[StrictStr, Field(..., description="the knowledge-base (its guid id)")], **kwargs) -> List[OptimizeIndexesGetReportsCmd]:  # noqa: E501
        ...
        >>> thread = api.get_index_optimzation_reports(session_id, organisation_id, kb_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_index_optimzation_reports_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_index_optimzation_reports_with_http_info(session_id, organisation_id, kb_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_index_optimzation_reports_with_http_info(self, session_id : Annotated[StrictStr, Field(..., description="a valid session-guid id.")], organisation_id : Annotated[StrictStr, Field(..., description="the organisation (its guid id)")], kb_id : Annotated[StrictStr, Field(..., description="the knowledge-base (its guid id)")], **kwargs) -> ApiResponse:  # noqa: E501
        """get optimization report list  # noqa: E501
        ...
        >>> thread = api.get_index_optimzation_reports_with_http_info(session_id, organisation_id, kb_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_index_optimzation_reports" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
