...
class CMExternalCrawlerRenameFolder(BaseModel):
    """
    ...
    old_folder_name_url: StrictStr = Field(..., alias="oldFolderNameUrl", description="the current document-folder name")
    new_folder_name_url: StrictStr = Field(..., alias="newFolderNameUrl", description="the new document-folder name")
    acls: StrictStr = Field(..., description="A list of security permission for the new document-folder.  Can be empty (ie. no security applied).")
    ...
    __properties = ["objectType", "organisationId", "kbId", "sid", "sourceId", "oldFolderNameUrl", "newFolderNameUrl", "acls", "encrypted", "seed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMExternalCrawlerRenameFolder:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMExternalCrawlerRenameFolder:
        """Create an instance of CMExternalCrawlerRenameFolder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMExternalCrawlerRenameFolder.parse_obj(obj)

        _obj = CMExternalCrawlerRenameFolder.parse_obj({
            "object_type": obj.get("objectType"),
            "organisation_id": obj.get("organisationId"),
            "kb_id": obj.get("kbId"),
            "sid": obj.get("sid"),
            "source_id": obj.get("sourceId"),
            "old_folder_name_url": obj.get("oldFolderNameUrl"),
            "new_folder_name_url": obj.get("newFolderNameUrl"),
            "acls": obj.get("acls"),
