...
class SearchCategory(BaseModel):
    ...
    sort_default: StrictStr = Field(..., alias="sortDefault")
    sort_asc_text: StrictStr = Field(..., alias="sortAscText")
    sort_desc_text: StrictStr = Field(..., alias="sortDescText")
    metadata: StrictStr = Field(...)
    display_name: StrictStr = Field(..., alias="displayName")
    sort: StrictBool = Field(...)
    min_value: StrictInt = Field(..., alias="minValue")
    max_value: StrictInt = Field(..., alias="maxValue")
    items: conlist(NameCounterLevel) = Field(...)
    __properties = ["scType", "categoryType", "order", "sortDefault", "sortAscText", "sortDescText", "metadata", "displayName", "sort", "minValue", "maxValue", "items"]
    ...
    def from_dict(cls, obj: dict) -> SearchCategory:
        ...
        _obj = SearchCategory.parse_obj({
            ...
            "category_type": obj.get("categoryType"),
            "order": obj.get("order"),
