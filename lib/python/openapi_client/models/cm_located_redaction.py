...
class CMLocatedRedaction(BaseModel):
    """
    CMLocatedRedaction
    """
    ...
    __properties = ["projectId", "sliceId", "documentKey", "redactionType", "queryId", "word", "redactionKey", "isRedacted", "page", "left", "bottom", "width", "height"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMLocatedRedaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMLocatedRedaction:
        """Create an instance of CMLocatedRedaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMLocatedRedaction.parse_obj(obj)

        _obj = CMLocatedRedaction.parse_obj({
