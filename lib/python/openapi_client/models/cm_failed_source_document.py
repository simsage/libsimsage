...
class CMFailedSourceDocument(BaseModel):
    ...
    delta_root_id: StrictStr = Field(..., alias="deltaRootId", description="For delta crawlers with multiple roots, the id of the document's delta root")
    run_id: StrictInt = Field(..., alias="runId", description="the timestamp of the crawler run adding the exception")
    ...
    __properties = ["organisationId", "kbId", "sourceId", "sourceSystemId", "webUrl", "deltaRootId", "runId", "errorMessage", "encrypted", "seed", "sid"]
