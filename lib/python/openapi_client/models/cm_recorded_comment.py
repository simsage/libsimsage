...
class CMRecordedComment(BaseModel):
    """
    CMRecordedComment
    """
    ...
    is_audit_event: StrictBool = Field(..., alias="isAuditEvent")
    __properties = ["created", "projectId", "sliceId", "documentKey", "commentLevel", "comment", "user", "isAuditEvent"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMRecordedComment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMRecordedComment:
        """Create an instance of CMRecordedComment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMRecordedComment.parse_obj(obj)

        _obj = CMRecordedComment.parse_obj({
            ...
            "user": obj.get("user"),
            "is_audit_event": obj.get("isAuditEvent")
        })
        return _obj
