...
class CMSource(BaseModel):
    ...
    weight: Union[StrictFloat, StrictInt] = Field(..., description="the importance of this source relative to others <0.0,1.0]")
    ...
    files_per_second: Union[StrictFloat, StrictInt] = Field(..., alias="filesPerSecond", description="Any value greater than 0 will cause the crawler to sleep for as many milliseconds between file uploads.")
    ...
    delta_indicator: StrictStr = Field(..., alias="deltaIndicator", description="A saved value indicating last crawler state")
    transmit_external_logs: StrictBool = Field(..., alias="transmitExternalLogs", description="enabling sending of logs to SimSage for external crawlers")
    source_error: CMSourceError = Field(..., alias="sourceError")
    external: Optional[StrictBool] = None
    crawling: Optional[StrictBool] = None
    busy: Optional[StrictBool] = None
    __properties = ["sourceId", "organisationId", "kbId", "weight", "nodeId", "name", "crawlerType", "schedule", "deleteFiles", "allowAnonymous", "processingLevel", "enablePreview", "filesPerSecond", "specificJson", "sessionId", "maxItems", "maxBotItems", "customRender", "edgeDeviceId", "numResults", "numFragments", "numErrors", "errorThreshold", "startTime", "endTime", "acls", "isCrawling", "numCrawledDocuments", "numConvertedDocuments", "numParsedDocuments", "numIndexedDocuments", "numFinishedDocuments", "numErroredDocuments", "numTotalDocuments", "numTotalErroredDocuments", "useDefaultRelationships", "isBusy", "storeBinary", "versioned", "writeToCassandra", "processorConfig", "enableDocumentSimilarity", "documentSimilarityThreshold", "isExternal", "useOCR", "useSTT", "deltaIndicator", "transmitExternalLogs", "sourceError", "external", "crawling", "busy"]
    ...
    def to_dict(self):
        ...
        if self.acls:
            ...
            _dict['acls'] = _items
        # override the default output from pydantic by calling `to_dict()` of source_error
        if self.source_error:
            _dict['sourceError'] = self.source_error.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: dict) -> CMSource:
        ...
        _obj = CMSource.parse_obj({
            ...
            "delta_indicator": obj.get("deltaIndicator"),
            "transmit_external_logs": obj.get("transmitExternalLogs"),
            "source_error": CMSourceError.from_dict(obj.get("sourceError")) if obj.get("sourceError") is not None else None,
