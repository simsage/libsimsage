...
class CMUploadDocument(BaseModel):
    ...
    categories: conlist(MDMetadataMapping) = Field(..., description="A list of special SimSage metadata categories for matching this document with.  Can be empty.")
    ...
    def from_dict(cls, obj: dict) -> CMUploadDocument:
        ...
        _obj = CMUploadDocument.parse_obj({
            ...
            "categories": [MDMetadataMapping.from_dict(_item) for _item in obj.get("categories")] if obj.get("categories") is not None else None,
            "size": obj.get("size"),
