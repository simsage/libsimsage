...
class CMExternalLogEntry(BaseModel):
    """
    write a log entry for the given source.  # noqa: E501
    """
    ...
    log_entry: StrictStr = Field(..., alias="logEntry", description="the log entry to write to SimSage from the external crawler.")
    ...
    __properties = ["objectType", "organisationId", "kbId", "sid", "sourceId", "logEntry", "encrypted", "seed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMExternalLogEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMExternalLogEntry:
        """Create an instance of CMExternalLogEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMExternalLogEntry.parse_obj(obj)

        _obj = CMExternalLogEntry.parse_obj({
            "object_type": obj.get("objectType"),
            "organisation_id": obj.get("organisationId"),
            "kb_id": obj.get("kbId"),
            "sid": obj.get("sid"),
            "source_id": obj.get("sourceId"),
            "log_entry": obj.get("logEntry"),
