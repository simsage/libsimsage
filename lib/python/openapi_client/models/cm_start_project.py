...
class CMStartProject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMStartProject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMStartProject:
        """Create an instance of CMStartProject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMStartProject.parse_obj(obj)

        _obj = CMStartProject.parse_obj({
