...
class CMExternalCrawlerSetDeltaToken(BaseModel):
    """
    ...
    delta_token: StrictStr = Field(..., alias="deltaToken", description="the delta-token to set.")
    ...
    __properties = ["objectType", "organisationId", "kbId", "sid", "sourceId", "deltaToken", "encrypted", "seed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMExternalCrawlerSetDeltaToken:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMExternalCrawlerSetDeltaToken:
        """Create an instance of CMExternalCrawlerSetDeltaToken from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMExternalCrawlerSetDeltaToken.parse_obj(obj)

        _obj = CMExternalCrawlerSetDeltaToken.parse_obj({
            "object_type": obj.get("objectType"),
            "organisation_id": obj.get("organisationId"),
            "kb_id": obj.get("kbId"),
            "sid": obj.get("sid"),
            "source_id": obj.get("sourceId"),
            "delta_token": obj.get("deltaToken"),
