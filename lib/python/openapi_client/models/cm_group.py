...
class CMGroup(BaseModel):
    ...
    original_name: StrictStr = Field(..., alias="originalName", description="the original-name of this group to help rename the group")
    user_id_list: conlist(StrictStr) = Field(..., alias="userIdList", description="a list of user-ids (can be empty) part of this group")
    __properties = ["organisationId", "name", "originalName", "userIdList"]
