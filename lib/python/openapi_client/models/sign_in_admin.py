...
class SignInAdmin(BaseModel):
    ...
    shared_secret_salt: StrictStr = Field(..., alias="sharedSecretSalt")
    ...
    __properties = ["organisationList", "sharedSecretSalt", "jobId", "returnAddress", "errorStr", "timeOut", "async", "isReturnResult", "email", "password", "roles", "remoteAddress", "session", "user", "organisationId", "returnResult"]
    ...
    def from_dict(cls, obj: dict) -> SignInAdmin:
        ...
        _obj = SignInAdmin.parse_obj({
            ...
            "shared_secret_salt": obj.get("sharedSecretSalt"),
