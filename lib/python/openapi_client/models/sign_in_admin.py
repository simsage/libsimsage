...
class SignInAdmin(BaseModel):
    ...
    __properties = ["jobId", "returnAddress", "errorStr", "timeOut", "async", "isReturnResult", "email", "password", "roles", "remoteAddress", "session", "user", "organisationId", "organisationList", "sharedSecretSalt", "returnResult"]
