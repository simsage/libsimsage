...
class CMProjectDefinitionTask(BaseModel):
    """
    CMProjectDefinitionTask
    """
    task_info: CMTaskInfo = Field(..., alias="taskInfo")
    detail: CMProjectDefinition = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMProjectDefinitionTask:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMProjectDefinitionTask:
        """Create an instance of CMProjectDefinitionTask from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMProjectDefinitionTask.parse_obj(obj)

        _obj = CMProjectDefinitionTask.parse_obj({
            "task_info": CMTaskInfo.from_dict(obj.get("taskInfo")) if obj.get("taskInfo") is not None else None,
            "detail": CMProjectDefinition.from_dict(obj.get("detail")) if obj.get("detail") is not None else None
        })
        return _obj
