...
class KnowledgeBase(BaseModel):
    ...
    __properties = ["kbId", "organisationId", "name", "email", "securityId", "created", "maxQueriesPerDay", "analyticsWindowInMonths", "enabled", "operatorEnabled", "capacityWarnings", "indexSchedule", "lastIndexOptimizationTime"]
