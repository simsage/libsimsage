...
class KnowledgeBase(BaseModel):
    ...
    is_optimizing: StrictBool = Field(..., alias="isOptimizing")
    optimization_progress: StrictInt = Field(..., alias="optimizationProgress")
    optimizing: Optional[StrictBool] = None
    __properties = ["kbId", "organisationId", "name", "email", "securityId", "created", "maxQueriesPerDay", "analyticsWindowInMonths", "enabled", "operatorEnabled", "capacityWarnings", "indexSchedule", "lastIndexOptimizationTime", "projectKb", "isOptimizing", "optimizationProgress", "optimizing"]
