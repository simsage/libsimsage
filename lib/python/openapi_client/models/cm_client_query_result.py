...
class CMClientQueryResult(BaseModel):
    ...
    source_id_to_counts: Dict[str, StrictInt] = Field(..., alias="sourceIdToCounts", description="a map of sourceId -> number of documents found inside this source")
    document_type_to_counts: Dict[str, StrictInt] = Field(..., alias="documentTypeToCounts", description="a map of document-type -> number of documents found of this type")
    ...
    __properties = ["messageType", "organisationId", "kbId", "text", "hasResult", "urlList", "metadata", "qnaScore", "imageList", "totalDocumentCount", "shardSizeList", "resultList", "spellingCorrection", "semanticSet", "knowEmail", "categoryList", "synSetList", "customRender", "sourceIdToCounts", "documentTypeToCounts", "savedSearchList", "querySummarization"]
    ...
    def from_dict(cls, obj: dict) -> CMClientQueryResult:
        ...
        _obj = CMClientQueryResult.parse_obj({
            ...
            "source_id_to_counts": obj.get("sourceIdToCounts"),
            "document_type_to_counts": obj.get("documentTypeToCounts"),
