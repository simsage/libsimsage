...
class CMKnowledgeBase(BaseModel):
    ...
    is_optimizing: StrictBool = Field(..., alias="isOptimizing", description="is the index optimizer active?")
    optimization_progress: StrictInt = Field(..., alias="optimizationProgress", description="how far along is the optimizer if it is active (0% to 100%)")
    optimizing: Optional[StrictBool] = None
    __properties = ["organisationId", "kbId", "name", "email", "securityId", "created", "maxQueriesPerDay", "analyticsWindowInMonths", "enabled", "operatorEnabled", "capacityWarnings", "indexSchedule", "lastIndexOptimizationTime", "isOptimizing", "optimizationProgress", "optimizing"]
    ...
    def from_dict(cls, obj: dict) -> CMKnowledgeBase:
        ...
        _obj = CMKnowledgeBase.parse_obj({
            ...
            "is_optimizing": obj.get("isOptimizing"),
            "optimization_progress": obj.get("optimizationProgress"),
            "optimizing": obj.get("optimizing")
        })
        return _obj
