...
class CMExternalMarkResetCrawl(BaseModel):
    """
    ...
    delta_reset_roots: conlist(StrictStr) = Field(..., alias="deltaResetRoots", description="optional for multi root delta crawlers the ids of the roots to reset")
    ...
    __properties = ["objectType", "organisationId", "kbId", "sid", "sourceId", "deltaResetRoots", "encrypted", "seed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMExternalMarkResetCrawl:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMExternalMarkResetCrawl:
        """Create an instance of CMExternalMarkResetCrawl from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMExternalMarkResetCrawl.parse_obj(obj)

        _obj = CMExternalMarkResetCrawl.parse_obj({
            "object_type": obj.get("objectType"),
            "organisation_id": obj.get("organisationId"),
            "kb_id": obj.get("kbId"),
            "sid": obj.get("sid"),
            "source_id": obj.get("sourceId"),
            "delta_reset_roots": obj.get("deltaResetRoots"),
