...
class CMSemantic(BaseModel):
    """
    A SimSAge semantic.  A semantic is an 'is-a' relationship.  A generalization/specialization relationship.  The 'word' (the more specialized part) is the primary-key/id of this relationship.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMSemantic:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMSemantic:
        """Create an instance of CMSemantic from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMSemantic.parse_obj(obj)

        _obj = CMSemantic.parse_obj({
            "word": obj.get("word"),
