...
class CMProjectSliceTask(BaseModel):
    """
    CMProjectSliceTask
    """
    task_info: CMTaskInfo = Field(..., alias="taskInfo")
    detail: CMProjectSlice = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMProjectSliceTask:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMProjectSliceTask:
        """Create an instance of CMProjectSliceTask from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMProjectSliceTask.parse_obj(obj)

        _obj = CMProjectSliceTask.parse_obj({
            "task_info": CMTaskInfo.from_dict(obj.get("taskInfo")) if obj.get("taskInfo") is not None else None,
            "detail": CMProjectSlice.from_dict(obj.get("detail")) if obj.get("detail") is not None else None
        })
        return _obj
