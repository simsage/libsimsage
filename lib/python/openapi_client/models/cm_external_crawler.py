...
class CMExternalCrawler(BaseModel):
    """
    request access to the given crawler by id.  # noqa: E501
    """
    ...
    __properties = ["objectType", "organisationId", "kbId", "sid", "sourceId", "encrypted", "seed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMExternalCrawler:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMExternalCrawler:
        """Create an instance of CMExternalCrawler from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMExternalCrawler.parse_obj(obj)

        _obj = CMExternalCrawler.parse_obj({
