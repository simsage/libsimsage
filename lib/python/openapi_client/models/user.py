...
class User(BaseModel):
    ...
    jwt_match_name_value_csv: StrictStr = Field(..., alias="jwtMatchNameValueCSV")
    __properties = ["id", "email", "firstName", "surname", "passwordHash", "confirmed", "roles", "operatorKBList", "groupList", "jwtMatchNameValueCSV"]
