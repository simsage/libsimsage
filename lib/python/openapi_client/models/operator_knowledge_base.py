...
class OperatorKnowledgeBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OperatorKnowledgeBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OperatorKnowledgeBase:
        """Create an instance of OperatorKnowledgeBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OperatorKnowledgeBase.parse_obj(obj)

        _obj = OperatorKnowledgeBase.parse_obj({
