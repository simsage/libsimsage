...
class SignInCmd(BaseModel):
    ...
    __properties = ["organisationList", "jobId", "returnAddress", "errorStr", "timeOut", "async", "isReturnResult", "email", "password", "roles", "remoteAddress", "session", "user", "organisationId", "returnResult"]
