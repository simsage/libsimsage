...
class CMExternalCrawlerStop(BaseModel):
    ...
    num_files_seen: StrictInt = Field(..., alias="numFilesSeen", description="the number of files seen during the run of this crawler")
    ...
    __properties = ["objectType", "organisationId", "kbId", "sid", "sourceId", "numErrors", "numFilesSeen", "runId", "encrypted", "seed"]
    ...
    def from_dict(cls, obj: dict) -> CMExternalCrawlerStop:
        ...
        _obj = CMExternalCrawlerStop.parse_obj({
            ...
            "num_files_seen": obj.get("numFilesSeen"),
