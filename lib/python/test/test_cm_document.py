...
from openapi_client.models.cm_document import CMDocument  # noqa: E501

class TestCMDocument(unittest.TestCase):
    """CMDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CMDocument:
        """Test CMDocument
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CMDocument`
        """
        model = CMDocument()  # noqa: E501
        if include_optional:
            return CMDocument(
                organisation_id = '',
                kb_id = '',
