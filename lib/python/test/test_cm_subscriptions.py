...
from openapi_client.models.cm_subscriptions import CMSubscriptions  # noqa: E501

class TestCMSubscriptions(unittest.TestCase):
    """CMSubscriptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CMSubscriptions:
        """Test CMSubscriptions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CMSubscriptions`
        """
        model = CMSubscriptions()  # noqa: E501
        if include_optional:
