...
**files_per_second** | **float** | Any value greater than 0.0 (can be fractional) indicates SimSage should limit how many requests it makes from the remote entity we&#39;re integrating with. | 
