...
impl CmFailedSourceDocument {
    ...
    pub fn new(organisation_id: String, kb_id: String, source_id: i32, source_system_id: String, web_url: String, delta_root_id: String, run_id: i64, error_message: String, encrypted: bool, seed: i32, sid: String) -> CmFailedSourceDocument {
