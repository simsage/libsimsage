...
/// CmExternalCrawlerMarkFileAsSeen : An mark-file-as-seen object.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CmExternalCrawlerMarkFileAsSeen {
...
impl CmExternalCrawlerMarkFileAsSeen {
    /// An mark-file-as-seen object.
    pub fn new(object_type: String, organisation_id: String, kb_id: String, sid: String, source_id: i32, asset: crate::models::Asset, encrypted: bool, seed: i32) -> CmExternalCrawlerMarkFileAsSeen {
