...
/// CmExternalLogEntry : write a log entry for the given source.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CmExternalLogEntry {
...
impl CmExternalLogEntry {
    /// write a log entry for the given source.
    pub fn new(object_type: String, organisation_id: String, kb_id: String, sid: String, source_id: i32, log_entry: String, encrypted: bool, seed: i32) -> CmExternalLogEntry {
        CmExternalLogEntry {
            object_type,
            organisation_id,
            kb_id,
