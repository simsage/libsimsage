...
pub struct CmSource {
    ...
    pub source_error: Box<crate::models::CmSourceError>,
...
impl CmSource {
    ...
    pub fn new(source_id: i32, organisation_id: String, kb_id: String, weight: f32, node_id: i32, name: String, crawler_type: String, schedule: String, delete_files: bool, allow_anonymous: bool, processing_level: String, enable_preview: bool, files_per_second: f32, specific_json: String, session_id: String, max_items: i64, max_bot_items: i64, custom_render: bool, edge_device_id: String, num_results: i32, num_fragments: i32, num_errors: i32, error_threshold: i32, start_time: i64, end_time: i64, acls: Vec<crate::models::CmDocumentAcl>, is_crawling: bool, num_crawled_documents: i32, num_converted_documents: i32, num_parsed_documents: i32, num_indexed_documents: i32, num_finished_documents: i32, num_errored_documents: i32, num_total_documents: i32, num_total_errored_documents: i32, use_default_relationships: bool, is_busy: bool, store_binary: bool, versioned: bool, write_to_cassandra: bool, processor_config: String, enable_document_similarity: bool, document_similarity_threshold: f32, is_external: bool, use_ocr: bool, use_stt: bool, delta_indicator: String, transmit_external_logs: bool, source_error: crate::models::CmSourceError) -> CmSource {
        CmSource {
            source_id,
            organisation_id,
            kb_id,
