...
pub struct CmClientQuery {
    ...
    #[serde(rename = "wordSynSet")]
    pub word_syn_set: ::std::collections::HashMap<String, i32>,
}

impl CmClientQuery {
    /// a client query object
    pub fn new(organisation_id: String, kb_list: Vec<String>, client_id: String, semantic_search: bool, qna_query: bool, query: String, filter: String, num_results: i32, score_threshold: f32, page: i32, page_size: i32, fragment_count: i32, max_word_distance: i32, source_id: String, shard_size_list: Vec<i32>, spelling_suggest: bool, group_similar_documents: bool, sort_by_age: bool, use_question_answering_ai: bool, word_syn_set: ::std::collections::HashMap<String, i32>) -> CmClientQuery {
        CmClientQuery {
            organisation_id,
            kb_list,
            client_id,
