...
export interface ZipSourceRequest {
    sessionId: string;
    cMZipSource: CMZipSource;
    aPIVersion?: ZipSourceAPIVersionEnum;
}
...
export class DocumentApi extends BaseAPI {
     ...
     */
    zipSource({ sessionId, cMZipSource, aPIVersion }: ZipSourceRequest): Observable<JsonMessage>
    zipSource({ sessionId, cMZipSource, aPIVersion }: ZipSourceRequest, opts?: OperationOpts): Observable<AjaxResponse<JsonMessage>>
    zipSource({ sessionId, cMZipSource, aPIVersion }: ZipSourceRequest, opts?: OperationOpts): Observable<JsonMessage | AjaxResponse<JsonMessage>> {
        throwIfNullOrUndefined(sessionId, 'sessionId', 'zipSource');
        throwIfNullOrUndefined(cMZipSource, 'cMZipSource', 'zipSource');
 ...
 * @enum {string}
 */
export enum ZipSourceAPIVersionEnum {
    _1 = '1'
}
