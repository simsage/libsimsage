 ...
 * @param deltaResetRoots optional for multi root delta crawlers the ids of the roots to reset
 * @param encrypted Do we need to add transport encryption
 * @param seed The seed used if encrypted
 */


data class CMExternalMarkResetCrawl (
    ...
    @Json(name = "deltaResetRoots")
    val deltaResetRoots: kotlin.collections.List<kotlin.String>,
