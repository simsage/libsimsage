 ...
 * @param oldFolderNameUrl the current document-folder name
 * @param newFolderNameUrl the new document-folder name
 * @param acls A list of security permission for the new document-folder.  Can be empty (ie. no security applied).
 * @param encrypted Do we need to add transport encryption
 * @param seed The seed used if encrypted
 */


data class CMExternalCrawlerRenameFolder (
    ...
    @Json(name = "oldFolderNameUrl")
    val oldFolderNameUrl: kotlin.String,

    /* the new document-folder name */
    @Json(name = "newFolderNameUrl")
    val newFolderNameUrl: kotlin.String,
