...
/**
 * CMDocumentAudit Class Doc Comment
 *
 * @category Class
 ...
 */
class CMDocumentAudit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMDocumentAudit';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email the email address of the user for this audit record
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The description of the audit event
     *
     * @return self
     */
