...
/**
 * CMInfo Class Doc Comment
 *
 * @category Class
 * @description An Info record contains information for external UI systems wishing to interact with SimSage.  This information is for a single-organisation and contains all the knowledge-bases and their information for this organisation.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CMInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMInfo';
    ...
    protected static $openAPITypes = [
        ...
        'kb_list' => '\OpenAPI\Client\Model\CMKnowledgeBaseInfo[]'
    ];
    ...
    */
     ...
     * Gets kb_list
     *
     * @return \OpenAPI\Client\Model\CMKnowledgeBaseInfo[]
     */
     ...
     * Sets kb_list
     *
     * @param \OpenAPI\Client\Model\CMKnowledgeBaseInfo[] $kb_list the list of knowledge-base information items that belong to the given organisation.
     *
     * @return self
     */
