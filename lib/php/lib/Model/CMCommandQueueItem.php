...
/**
 * CMCommandQueueItem Class Doc Comment
 *
 * @category Class
 ...
 */
class CMCommandQueueItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMCommandQueueItem';
    ...
    */
     ...
     * Sets job_id
     *
     * @param string $job_id the job-id, primary key
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param int $expiry when this lock will expire as a Unix date-time
     *
     * @return self
     */
