...
/**
 * CMSynSetList Class Doc Comment
 *
 * @category Class
 ...
 */
class CMSynSetList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMSynSetList';
    ...
    */
     ...
     * Sets list
     *
     * @param string $list A list of CMSynSet items
     *
     * @return self
     */
     ...
     * Sets total_size
     *
     * @param int $total_size the number of total SynSet items in your query
     *
     * @return self
     */
