...
/**
 * CMRestoreFromText Class Doc Comment
 *
 * @category Class
 ...
 */
class CMRestoreFromText implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMRestoreFromText';
    ...
    */
     ...
     * Sets base64_text
     *
     * @param string $base64_text the base64 text to restore from.
     *
     * @return self
     */
     ...
     * Sets file_type
     *
     * @param string $file_type the file-type of the base64 text (must be text/plain)
     *
     * @return self
     */
