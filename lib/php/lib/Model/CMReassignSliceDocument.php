...
/**
 * CMReassignSliceDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CMReassignSliceDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMReassignSliceDocument';
    ...
    protected static $setters = [
        ...
        'new_user_id' => 'setNewUserId',
        'new_slice_id' => 'setNewSliceId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('new_user_id', $data ?? [], null);
        $this->setIfExists('new_slice_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['new_user_id'] === null) {
            $invalidProperties[] = "'new_user_id' can't be null";
        }
        if ($this->container['new_slice_id'] === null) {
            $invalidProperties[] = "'new_slice_id' can't be null";
        }
    ...
    {
        return $this->container['new_user_id'];
    }

    /**
     * Sets new_user_id
     *
     * @param string $new_user_id new_user_id
     *
     * @return self
     */
    public function setNewUserId($new_user_id)
    {
        if (is_null($new_user_id)) {
            throw new \InvalidArgumentException('non-nullable new_user_id cannot be null');
        }
        $this->container['new_user_id'] = $new_user_id;
     ...
     * @return string
     */
    public function getNewSliceId()
    {
        return $this->container['new_slice_id'];
    }

    /**
     * Sets new_slice_id
     *
     * @param string $new_slice_id new_slice_id
     *
     * @return self
     */
    public function setNewSliceId($new_slice_id)
    {
        if (is_null($new_slice_id)) {
            throw new \InvalidArgumentException('non-nullable new_slice_id cannot be null');
        }
        $this->container['new_slice_id'] = $new_slice_id;
