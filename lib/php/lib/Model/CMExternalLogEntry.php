...
/**
 * CMExternalLogEntry Class Doc Comment
 *
 * @category Class
 * @description write a log entry for the given source.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CMExternalLogEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMExternalLogEntry';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('log_entry', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['log_entry'] === null) {
            $invalidProperties[] = "'log_entry' can't be null";
        }
    ...
    {
        return $this->container['log_entry'];
    }

    /**
     * Sets log_entry
     *
     * @param string $log_entry the log entry to write to SimSage from the external crawler.
     *
     * @return self
     */
    public function setLogEntry($log_entry)
    {
        if (is_null($log_entry)) {
            throw new \InvalidArgumentException('non-nullable log_entry cannot be null');
        }
        $this->container['log_entry'] = $log_entry;
