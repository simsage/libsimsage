...
class Identifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const IDENTIFIER_TYPE_CREDIT_CARD_NUMBER = 'CREDIT_CARD_NUMBER';
    public const IDENTIFIER_TYPE_ACCOUNT_NUMBER = 'ACCOUNT_NUMBER';
    public const IDENTIFIER_TYPE_POLICY_NUMBER = 'POLICY_NUMBER';
    ...
    {
        return [
            self::IDENTIFIER_TYPE_CREDIT_CARD_NUMBER,
            self::IDENTIFIER_TYPE_ACCOUNT_NUMBER,
            self::IDENTIFIER_TYPE_POLICY_NUMBER,
        ];
    }
