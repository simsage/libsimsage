...
/**
 * CMSimilarDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class CMSimilarDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMSimilarDocument';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url the url of the document that is similar
     *
     * @return self
     */
     ...
     * Sets url_id
     *
     * @param int $url_id the url-id of the document that is similar
     *
     * @return self
     */
     ...
     * Sets similarity
     *
     * @param float $similarity how similar that document is (e.g. 1.0 = 100%)
     *
     * @return self
     */
