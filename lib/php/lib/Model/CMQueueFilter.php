...
/**
 * CMQueueFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CMQueueFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMQueueFilter';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('show_all', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['show_all'] === null) {
            $invalidProperties[] = "'show_all' can't be null";
        }
    ...
    {
        return $this->container['show_all'];
    }

    /**
     * Sets show_all
     *
     * @param bool $show_all show_all
     *
     * @return self
     */
    ...
    {
        if (is_null($show_all)) {
            throw new \InvalidArgumentException('non-nullable show_all cannot be null');
        }
        $this->container['show_all'] = $show_all;
