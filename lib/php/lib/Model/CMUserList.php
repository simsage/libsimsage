 ...
 */
class CMUserList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMUserList';
    ...
    */
     ...
     * Sets user_list
     *
     * @param \OpenAPI\Client\Model\CMUser[] $user_list the list of user objects.
     *
     * @return self
     */
     ...
     * Sets user_count
     *
     * @param int $user_count the total user count.
     *
     * @return self
     */
