 ...
 */
class CMGroupList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMGroupList';
    ...
    */
     ...
     * Sets group_list
     *
     * @param \OpenAPI\Client\Model\CMGroup[] $group_list the list of filtered/paginated groups
     *
     * @return self
     */
     ...
     * Sets user_list
     *
     * @param \OpenAPI\Client\Model\CMUser[] $user_list the list of users for all groups
     *
     * @return self
     */
