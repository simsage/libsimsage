...
/**
 * OptimizeIndexesGetReportsCmd Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OptimizeIndexesGetReportsCmd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptimizeIndexesGetReportsCmd';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('report_list', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['report_list'] === null) {
            $invalidProperties[] = "'report_list' can't be null";
        }
    ...
    {
        return $this->container['report_list'];
    }

    /**
     * Sets report_list
     *
     * @param int[] $report_list report_list
     *
     * @return self
     */
    public function setReportList($report_list)
    {
        if (is_null($report_list)) {
            throw new \InvalidArgumentException('non-nullable report_list cannot be null');
        }
        $this->container['report_list'] = $report_list;
