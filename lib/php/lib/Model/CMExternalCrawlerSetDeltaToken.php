...
/**
 * CMExternalCrawlerSetDeltaToken Class Doc Comment
 *
 * @category Class
 ...
 */
class CMExternalCrawlerSetDeltaToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMExternalCrawlerSetDeltaToken';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['delta_token'] === null) {
            $invalidProperties[] = "'delta_token' can't be null";
        }
     ...
     * Sets delta_token
     *
     * @param string $delta_token the delta-token to set.
     *
     * @return self
     */
    public function setDeltaToken($delta_token)
    {
        if (is_null($delta_token)) {
            throw new \InvalidArgumentException('non-nullable delta_token cannot be null');
        }
