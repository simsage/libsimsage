...
/**
 * CMDocumentHashTag Class Doc Comment
 *
 * @category Class
 ...
 */
class CMDocumentHashTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMDocumentHashTag';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('hash_tag_list', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hash_tag_list'] === null) {
            $invalidProperties[] = "'hash_tag_list' can't be null";
        }
    ...
    {
        return $this->container['hash_tag_list'];
    }

    /**
     * Sets hash_tag_list
     *
     * @param string[] $hash_tag_list a list of hash-tags for this document
     *
     * @return self
     */
    public function setHashTagList($hash_tag_list)
    {
        if (is_null($hash_tag_list)) {
            throw new \InvalidArgumentException('non-nullable hash_tag_list cannot be null');
        }
        $this->container['hash_tag_list'] = $hash_tag_list;
