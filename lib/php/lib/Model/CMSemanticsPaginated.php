...
/**
 * CMSemanticsPaginated Class Doc Comment
 *
 * @category Class
 ...
 */
class CMSemanticsPaginated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMSemanticsPaginated';
    ...
    */
     ...
     * Sets prev_word
     *
     * @param string $prev_word pagination control, the last semantic word we looked for previously
     *
     * @return self
     */
     ...
     * Sets page_size
     *
     * @param int $page_size the number of semantics to return at a time.
     *
     * @return self
     */
     ...
     * Sets filter
     *
     * @param string $filter An optional string filter to apply to all semantics in the search.  Can be empty in which case SimSage will return all semantics paginated.
     *
     * @return self
     */
