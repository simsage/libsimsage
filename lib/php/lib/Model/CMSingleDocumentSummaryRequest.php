...
/**
 * CMSingleDocumentSummaryRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CMSingleDocumentSummaryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMSingleDocumentSummaryRequest';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url the url of the document to summarize
     *
     * @return self
     */
     ...
     * Sets top
     *
     * @param int $top the top-n sentences to return for the summary of the documents
     *
     * @return self
     */
