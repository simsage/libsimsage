...
/**
 * CMSynonymsPaginated Class Doc Comment
 *
 * @category Class
 ...
 */
class CMSynonymsPaginated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMSynonymsPaginated';
    ...
    */
     ...
     * Sets prev_id
     *
     * @param int|null $prev_id pagination control, the last synonym we looked for previously
     *
     * @return self
     */
     ...
     * Sets page_size
     *
     * @param int $page_size the number of synonyms to return at a time.
     *
     * @return self
     */
     ...
     * Sets filter
     *
     * @param string $filter An optional string filter to apply to all synonyms in the search.  Can be empty in which case SimSage will return all synonyms paginated.
     *
     * @return self
     */
