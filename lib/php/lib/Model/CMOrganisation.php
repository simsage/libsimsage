...
/**
 * CMOrganisation Class Doc Comment
 *
 * @category Class
 * @description A SimSage organisation object.  Represents a SimSage top-level tenant, aka. an organisation.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CMOrganisation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMOrganisation';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id the organisation (its guid id).
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool $enabled true if the organisation is enabled (active/operational)
     *
     * @return self
     */
     ...
     *
     * @param bool $auto_create_sso_users if enabled, SSO users will auto-create their accounts
     *
     * @return self
     */
     ...
     *
     * @param string[] $auto_create_sso_domain_list a list of the allowed domain postfixes for the emails (e.g. simsage.co.uk)
     *
     * @return self
     */
     ...
     *
     * @param string[] $auto_create_ssoacl_list a list of the ACLs initially assigned to each new user of they need creating
     *
     * @return self
     */
     ...
     *
     * @param string[] $auto_create_sso_role_list a list of the SimSage Roles initially assigned to each new user of they need creating
     *
     * @return self
     */
