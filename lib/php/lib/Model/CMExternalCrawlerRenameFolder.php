...
/**
 * CMExternalCrawlerRenameFolder Class Doc Comment
 *
 * @category Class
 ...
 */
class CMExternalCrawlerRenameFolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMExternalCrawlerRenameFolder';
    ...
    protected static $openAPITypes = [
        ...
        'sid' => 'string',
        'source_id' => 'int',
        'old_folder_name_url' => 'string',
        'new_folder_name_url' => 'string',
        'acls' => 'string',
        'encrypted' => 'bool',
        'seed' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'sid' => null,
        'source_id' => 'int32',
        'old_folder_name_url' => null,
        'new_folder_name_url' => null,
        'acls' => null,
        'encrypted' => null,
        'seed' => 'int32'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'sid' => false,
		'source_id' => false,
		'old_folder_name_url' => false,
		'new_folder_name_url' => false,
		'acls' => false,
		'encrypted' => false,
		'seed' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'sid' => 'sid',
        'source_id' => 'sourceId',
        'old_folder_name_url' => 'oldFolderNameUrl',
        'new_folder_name_url' => 'newFolderNameUrl',
        'acls' => 'acls',
        'encrypted' => 'encrypted',
        'seed' => 'seed'
    ];
    ...
    protected static $setters = [
        ...
        'old_folder_name_url' => 'setOldFolderNameUrl',
        'new_folder_name_url' => 'setNewFolderNameUrl',
        'acls' => 'setAcls',
    ...
    protected static $getters = [
        ...
        'old_folder_name_url' => 'getOldFolderNameUrl',
        'new_folder_name_url' => 'getNewFolderNameUrl',
        'acls' => 'getAcls',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('old_folder_name_url', $data ?? [], null);
        $this->setIfExists('new_folder_name_url', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['old_folder_name_url'] === null) {
            $invalidProperties[] = "'old_folder_name_url' can't be null";
        }
        if ($this->container['new_folder_name_url'] === null) {
            $invalidProperties[] = "'new_folder_name_url' can't be null";
        }
    ...
    /**
     * Gets old_folder_name_url
     *
     * @return string
     */
    public function getOldFolderNameUrl()
    {
        return $this->container['old_folder_name_url'];
    }

    /**
     * Sets old_folder_name_url
     *
     * @param string $old_folder_name_url the current document-folder name
     *
     * @return self
     */
    public function setOldFolderNameUrl($old_folder_name_url)
    {
        if (is_null($old_folder_name_url)) {
            throw new \InvalidArgumentException('non-nullable old_folder_name_url cannot be null');
        }
        $this->container['old_folder_name_url'] = $old_folder_name_url;

        return $this;
    }

    /**
     * Gets new_folder_name_url
     *
     * @return string
     */
    public function getNewFolderNameUrl()
    {
        return $this->container['new_folder_name_url'];
    }

    /**
     * Sets new_folder_name_url
     *
     * @param string $new_folder_name_url the new document-folder name
     *
     * @return self
     */
    public function setNewFolderNameUrl($new_folder_name_url)
    {
        if (is_null($new_folder_name_url)) {
            throw new \InvalidArgumentException('non-nullable new_folder_name_url cannot be null');
        }
        $this->container['new_folder_name_url'] = $new_folder_name_url;
     ...
     * Sets acls
     *
     * @param string $acls A list of security permission for the new document-folder.  Can be empty (ie. no security applied).
     *
     * @return self
     */
