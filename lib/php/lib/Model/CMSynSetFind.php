...
/**
 * CMSynSetFind Class Doc Comment
 *
 * @category Class
 ...
 */
class CMSynSetFind implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMSynSetFind';
    ...
    */
     ...
     * Sets page
     *
     * @param int $page pagination control, the page to get (starting at zero (0))
     *
     * @return self
     */
     ...
     * Sets page_size
     *
     * @param int $page_size The number of results to return maximum
     *
     * @return self
     */
     ...
     * Sets filter
     *
     * @param string $filter the synset(s) to look for
     *
     * @return self
     */
