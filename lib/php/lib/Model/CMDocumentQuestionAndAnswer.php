...
/**
 * CMDocumentQuestionAndAnswer Class Doc Comment
 *
 * @category Class
 ...
 */
class CMDocumentQuestionAndAnswer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMDocumentQuestionAndAnswer';
    ...
    protected static $setters = [
        ...
        'url' => 'setUrl',
        'url_id' => 'setUrlId',
        'conversation_list' => 'setConversationList',
        'answer' => 'setAnswer'
    ];
    ...
    protected static $getters = [
        ...
        'url' => 'getUrl',
        'url_id' => 'getUrlId',
        'conversation_list' => 'getConversationList',
        'answer' => 'getAnswer'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('conversation_list', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['conversation_list'] === null) {
            $invalidProperties[] = "'conversation_list' can't be null";
        }
     ...
     * Sets url_id
     *
     * @param int $url_id The unique URL-ID of a document.
     *
     * @return self
     */
    ...
    /**
     * Gets conversation_list
     *
     * @return string
     */
    public function getConversationList()
    {
        return $this->container['conversation_list'];
    }

    /**
     * Sets conversation_list
     *
     * @param string $conversation_list the context of the conversation thusfar
     *
     * @return self
     */
    public function setConversationList($conversation_list)
    {
        if (is_null($conversation_list)) {
            throw new \InvalidArgumentException('non-nullable conversation_list cannot be null');
        }
        $this->container['conversation_list'] = $conversation_list;
     ...
     * Sets answer
     *
     * @param string $answer The answer for the given question
     *
     * @return self
     */
