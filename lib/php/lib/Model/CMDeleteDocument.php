...
/**
 * CMDeleteDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class CMDeleteDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMDeleteDocument';
    ...
    */
     ...
     *
     * @param string $organisation_id the organisation (its guid id) this document is to be deleted for.
     *
     * @return self
     */
     ...
     * Sets kb_id
     *
     * @param string $kb_id the knowledge-base (its guid id) this document is to be deleted for.
     *
     * @return self
     */
     ...
     * Sets source_id
     *
     * @param int $source_id the source-id of this crawler (ie. the crawler's id) this document belongs to.
     *
     * @return self
     */
