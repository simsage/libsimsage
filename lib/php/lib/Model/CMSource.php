...
class CMSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'source_error' => '\OpenAPI\Client\Model\CMSourceError',
        'external' => 'bool',
        'crawling' => 'bool',
        'busy' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('source_error', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['source_error'] === null) {
            $invalidProperties[] = "'source_error' can't be null";
        }
     ...
     * Sets weight
     *
     * @param float $weight the importance of this source relative to others <0.0,1.0]
     *
     * @return self
     */
     ...
     * Gets source_error
     *
     * @return \OpenAPI\Client\Model\CMSourceError
     */
    public function getSourceError()
    {
        return $this->container['source_error'];
    }

    /**
     * Sets source_error
     *
     * @param \OpenAPI\Client\Model\CMSourceError $source_error source_error
     *
     * @return self
     */
    public function setSourceError($source_error)
    {
        if (is_null($source_error)) {
            throw new \InvalidArgumentException('non-nullable source_error cannot be null');
        }
        $this->container['source_error'] = $source_error;
