...
class CMSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float $files_per_second Any value greater than 0.0 (can be fractional) indicates SimSage should limit how many requests it makes from the remote entity we're integrating with.
     *
     * @return self
     */
