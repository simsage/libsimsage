...
/**
 * CMKnowledgeBaseExport Class Doc Comment
 *
 * @category Class
 ...
 */
class CMKnowledgeBaseExport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMKnowledgeBaseExport';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('export_config', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['exporter'] === null) {
            $invalidProperties[] = "'exporter' can't be null";
        }
        if ($this->container['export_config'] === null) {
            $invalidProperties[] = "'export_config' can't be null";
        }
    ...
    {
        return $this->container['export_config'];
    }

    /**
     * Sets export_config
     *
     * @param array<string,object> $export_config export_config
     *
     * @return self
     */
    public function setExportConfig($export_config)
    {
        if (is_null($export_config)) {
            throw new \InvalidArgumentException('non-nullable export_config cannot be null');
        }
        $this->container['export_config'] = $export_config;
