...
/**
    ...
    /**
     * Operation markCrawlAsDeltaReset
     *
     * Update delta token
     *
     * @param  \OpenAPI\Client\Model\CMExternalMarkResetCrawl $cm_external_mark_reset_crawl cm_external_mark_reset_crawl (required)
     * @param  string $api_version api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markCrawlAsDeltaReset'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\JsonMessage
     */
    public function markCrawlAsDeltaReset($cm_external_mark_reset_crawl, $api_version = null, string $contentType = self::contentTypes['markCrawlAsDeltaReset'][0])
    {
        list($response) = $this->markCrawlAsDeltaResetWithHttpInfo($cm_external_mark_reset_crawl, $api_version, $contentType);
        return $response;
    }

    /**
     * Operation markCrawlAsDeltaResetWithHttpInfo
     *
     * Update delta token
     *
     * @param  \OpenAPI\Client\Model\CMExternalMarkResetCrawl $cm_external_mark_reset_crawl (required)
     * @param  string $api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markCrawlAsDeltaReset'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     ...
     * @return array of \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\JsonMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function markCrawlAsDeltaResetWithHttpInfo($cm_external_mark_reset_crawl, $api_version = null, string $contentType = self::contentTypes['markCrawlAsDeltaReset'][0])
    {
        $request = $this->markCrawlAsDeltaResetRequest($cm_external_mark_reset_crawl, $api_version, $contentType);
    ...
    /**
     * Operation markCrawlAsDeltaResetAsync
     *
     * Update delta token
     *
     * @param  \OpenAPI\Client\Model\CMExternalMarkResetCrawl $cm_external_mark_reset_crawl (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function markCrawlAsDeltaResetAsync($cm_external_mark_reset_crawl, $api_version = null, string $contentType = self::contentTypes['markCrawlAsDeltaReset'][0])
    {
        return $this->markCrawlAsDeltaResetAsyncWithHttpInfo($cm_external_mark_reset_crawl, $api_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation markCrawlAsDeltaResetAsyncWithHttpInfo
     *
     * Update delta token
     *
     * @param  \OpenAPI\Client\Model\CMExternalMarkResetCrawl $cm_external_mark_reset_crawl (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function markCrawlAsDeltaResetAsyncWithHttpInfo($cm_external_mark_reset_crawl, $api_version = null, string $contentType = self::contentTypes['markCrawlAsDeltaReset'][0])
    {
        $returnType = '\OpenAPI\Client\Model\JsonMessage';
        $request = $this->markCrawlAsDeltaResetRequest($cm_external_mark_reset_crawl, $api_version, $contentType);
    ...
    /**
     * Create request for operation 'markCrawlAsDeltaReset'
     *
     * @param  \OpenAPI\Client\Model\CMExternalMarkResetCrawl $cm_external_mark_reset_crawl (required)
     * @param  string $api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markCrawlAsDeltaReset'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function markCrawlAsDeltaResetRequest($cm_external_mark_reset_crawl, $api_version = null, string $contentType = self::contentTypes['markCrawlAsDeltaReset'][0])
    {

        // verify the required parameter 'cm_external_mark_reset_crawl' is set
        if ($cm_external_mark_reset_crawl === null || (is_array($cm_external_mark_reset_crawl) && count($cm_external_mark_reset_crawl) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cm_external_mark_reset_crawl when calling markCrawlAsDeltaReset'
            );
        }



        $resourcePath = '/api/crawler/external/crawler/mark-as-reset';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($cm_external_mark_reset_crawl)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cm_external_mark_reset_crawl));
            } else {
                $httpBody = $cm_external_mark_reset_crawl;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  string $session_id a valid SimSage Session id. (required)
     * @param  \OpenAPI\Client\Model\CMSyncGDrive $cm_sync_g_drive cm_sync_g_drive (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sync'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function sync($session_id, $cm_sync_g_drive, string $contentType = self::contentTypes['sync'][0])
    {
        list($response) = $this->syncWithHttpInfo($session_id, $cm_sync_g_drive, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $session_id a valid SimSage Session id. (required)
     * @param  \OpenAPI\Client\Model\CMSyncGDrive $cm_sync_g_drive (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sync'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncWithHttpInfo($session_id, $cm_sync_g_drive, string $contentType = self::contentTypes['sync'][0])
    {
        $request = $this->syncRequest($session_id, $cm_sync_g_drive, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncAsync($session_id, $cm_sync_g_drive, string $contentType = self::contentTypes['sync'][0])
    {
        return $this->syncAsyncWithHttpInfo($session_id, $cm_sync_g_drive, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncAsyncWithHttpInfo($session_id, $cm_sync_g_drive, string $contentType = self::contentTypes['sync'][0])
    {
        $returnType = 'object';
        $request = $this->syncRequest($session_id, $cm_sync_g_drive, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function syncRequest($session_id, $cm_sync_g_drive, string $contentType = self::contentTypes['sync'][0])
    {

        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling sync'
            );
        }

        // verify the required parameter 'cm_sync_g_drive' is set
        if ($cm_sync_g_drive === null || (is_array($cm_sync_g_drive) && count($cm_sync_g_drive) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cm_sync_g_drive when calling sync'
            );
        }


        $resourcePath = '/api/crawler/syncgdrivegroups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($cm_sync_g_drive)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cm_sync_g_drive));
            } else {
                $httpBody = $cm_sync_g_drive;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
