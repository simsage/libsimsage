...
/**
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\CMGroupList
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\CMGroupList, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CMUserList|\OpenAPI\Client\Model\JsonMessage
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CMUserList|\OpenAPI\Client\Model\JsonMessage, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation groupEditInfo
     *
     * Get Group edit information
     *
     * @param  string $organisation_id the main organisation (its guid id) to get users for (required)
     * @param  string $session_id a valid SimSage Session id. (required)
     * @param  \OpenAPI\Client\Model\CMGroupEditInfo $cm_group_edit_info cm_group_edit_info (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['groupEditInfo'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\CMGroupList
     */
    public function groupEditInfo($organisation_id, $session_id, $cm_group_edit_info, string $contentType = self::contentTypes['groupEditInfo'][0])
    {
        list($response) = $this->groupEditInfoWithHttpInfo($organisation_id, $session_id, $cm_group_edit_info, $contentType);
        return $response;
    }

    /**
     * Operation groupEditInfoWithHttpInfo
     *
     * Get Group edit information
     *
     * @param  string $organisation_id the main organisation (its guid id) to get users for (required)
     * @param  string $session_id a valid SimSage Session id. (required)
     * @param  \OpenAPI\Client\Model\CMGroupEditInfo $cm_group_edit_info (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['groupEditInfo'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\CMGroupList, HTTP status code, HTTP response headers (array of strings)
     */
    public function groupEditInfoWithHttpInfo($organisation_id, $session_id, $cm_group_edit_info, string $contentType = self::contentTypes['groupEditInfo'][0])
    {
        $request = $this->groupEditInfoRequest($organisation_id, $session_id, $cm_group_edit_info, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function groupEditInfoAsync($organisation_id, $session_id, $cm_group_edit_info, string $contentType = self::contentTypes['groupEditInfo'][0])
    {
        return $this->groupEditInfoAsyncWithHttpInfo($organisation_id, $session_id, $cm_group_edit_info, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation groupEditInfoAsyncWithHttpInfo
     *
     * Get Group edit information
     *
     * @param  string $organisation_id the main organisation (its guid id) to get users for (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function groupEditInfoAsyncWithHttpInfo($organisation_id, $session_id, $cm_group_edit_info, string $contentType = self::contentTypes['groupEditInfo'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CMGroupList';
        $request = $this->groupEditInfoRequest($organisation_id, $session_id, $cm_group_edit_info, $contentType);
    ...
    /**
     * Create request for operation 'groupEditInfo'
     *
     * @param  string $organisation_id the main organisation (its guid id) to get users for (required)
     * @param  string $session_id a valid SimSage Session id. (required)
     * @param  \OpenAPI\Client\Model\CMGroupEditInfo $cm_group_edit_info (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function groupEditInfoRequest($organisation_id, $session_id, $cm_group_edit_info, string $contentType = self::contentTypes['groupEditInfo'][0])
    {

        // verify the required parameter 'organisation_id' is set
        if ($organisation_id === null || (is_array($organisation_id) && count($organisation_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organisation_id when calling groupEditInfo'
            );
        }
        ...
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling groupEditInfo'
            );
        }

        // verify the required parameter 'cm_group_edit_info' is set
        if ($cm_group_edit_info === null || (is_array($cm_group_edit_info) && count($cm_group_edit_info) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cm_group_edit_info when calling groupEditInfo'
            );
        }


        $resourcePath = '/api/auth/group-edit-info/{organisationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($cm_group_edit_info)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cm_group_edit_info));
            } else {
                $httpBody = $cm_group_edit_info;
            }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\CMUserWithExtras
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\CMUserWithExtras, HTTP status code, HTTP response headers (array of strings)
     */
