...
export interface GetIndexOptimzationReportRequest {
    sessionId: string;
...
export interface GetIndexOptimzationReportsRequest {
    sessionId: string;
    organisationId: string;
    kbId: string;
}
...
export class StatsApi extends BaseAPI {
     ...
     */
    getIndexOptimzationReport({ sessionId, organisationId, kbId, id }: GetIndexOptimzationReportRequest): Observable<Array<OptimizeIndexesGetReportCmd>>
    getIndexOptimzationReport({ sessionId, organisationId, kbId, id }: GetIndexOptimzationReportRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<OptimizeIndexesGetReportCmd>>>
    getIndexOptimzationReport({ sessionId, organisationId, kbId, id }: GetIndexOptimzationReportRequest, opts?: OperationOpts): Observable<Array<OptimizeIndexesGetReportCmd> | AjaxResponse<Array<OptimizeIndexesGetReportCmd>>> {
        throwIfNullOrUndefined(sessionId, 'sessionId', 'getIndexOptimzationReport');
        throwIfNullOrUndefined(organisationId, 'organisationId', 'getIndexOptimzationReport');
        throwIfNullOrUndefined(kbId, 'kbId', 'getIndexOptimzationReport');
        throwIfNullOrUndefined(id, 'id', 'getIndexOptimzationReport');
     ...
     */
    getIndexOptimzationReports({ sessionId, organisationId, kbId }: GetIndexOptimzationReportsRequest): Observable<Array<OptimizeIndexesGetReportsCmd>>
    getIndexOptimzationReports({ sessionId, organisationId, kbId }: GetIndexOptimzationReportsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<OptimizeIndexesGetReportsCmd>>>
    getIndexOptimzationReports({ sessionId, organisationId, kbId }: GetIndexOptimzationReportsRequest, opts?: OperationOpts): Observable<Array<OptimizeIndexesGetReportsCmd> | AjaxResponse<Array<OptimizeIndexesGetReportsCmd>>> {
        throwIfNullOrUndefined(sessionId, 'sessionId', 'getIndexOptimzationReports');
        throwIfNullOrUndefined(organisationId, 'organisationId', 'getIndexOptimzationReports');
        throwIfNullOrUndefined(kbId, 'kbId', 'getIndexOptimzationReports');
     ...
     * System Logs
     */
    systemLogs({ organisationId, year, month, day, hour, hours, sessionId }: SystemLogsRequest): Observable<Array<CMLoggerEntry>>
    systemLogs({ organisationId, year, month, day, hour, hours, sessionId }: SystemLogsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<CMLoggerEntry>>>
    systemLogs({ organisationId, year, month, day, hour, hours, sessionId }: SystemLogsRequest, opts?: OperationOpts): Observable<Array<CMLoggerEntry> | AjaxResponse<Array<CMLoggerEntry>>> {
        throwIfNullOrUndefined(organisationId, 'organisationId', 'systemLogs');
        throwIfNullOrUndefined(year, 'year', 'systemLogs');
        throwIfNullOrUndefined(month, 'month', 'systemLogs');
        throwIfNullOrUndefined(day, 'day', 'systemLogs');
        throwIfNullOrUndefined(hour, 'hour', 'systemLogs');
        throwIfNullOrUndefined(hours, 'hours', 'systemLogs');
        ...
        return this.request<Array<CMLoggerEntry>>({
            url: '/api/stats/system-logs/{organisationId}/{year}/{month}/{day}/{hour}/{hours}'.replace('{organisationId}', encodeURI(organisationId)).replace('{year}', encodeURI(year)).replace('{month}', encodeURI(month)).replace('{day}', encodeURI(day)).replace('{hour}', encodeURI(hour)).replace('{hours}', encodeURI(hours)),
            method: 'GET',
            headers,
        }, opts?.responseOpts);
    };
