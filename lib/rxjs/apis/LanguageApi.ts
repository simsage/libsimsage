...
export interface OptimizeIndexesAbortRequest {
    sessionId: string;
    cMOptimizeIndex: CMOptimizeIndex;
    aPIVersion?: OptimizeIndexesAbortAPIVersionEnum;
}
...
export class LanguageApi extends BaseAPI {
     ...
     */
    optimizeIndexesAbort({ sessionId, cMOptimizeIndex, aPIVersion }: OptimizeIndexesAbortRequest): Observable<JsonMessage>
    optimizeIndexesAbort({ sessionId, cMOptimizeIndex, aPIVersion }: OptimizeIndexesAbortRequest, opts?: OperationOpts): Observable<AjaxResponse<JsonMessage>>
    optimizeIndexesAbort({ sessionId, cMOptimizeIndex, aPIVersion }: OptimizeIndexesAbortRequest, opts?: OperationOpts): Observable<JsonMessage | AjaxResponse<JsonMessage>> {
        throwIfNullOrUndefined(sessionId, 'sessionId', 'optimizeIndexesAbort');
        throwIfNullOrUndefined(cMOptimizeIndex, 'cMOptimizeIndex', 'optimizeIndexesAbort');
        ...
        return this.request<JsonMessage>({
            url: '/api/language/optimize-indexes-abort',
            method: 'PUT',
            headers,
            body: cMOptimizeIndex,
        }, opts?.responseOpts);
 ...
 * @enum {string}
 */
export enum OptimizeIndexesAbortAPIVersionEnum {
    _1 = '1'
}
/**
 * @export
