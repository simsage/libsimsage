...
export interface MarkCrawlAsDeltaResetRequest {
    cMExternalMarkResetCrawl: CMExternalMarkResetCrawl;
    aPIVersion?: MarkCrawlAsDeltaResetAPIVersionEnum;
}
...
export class CrawlerApi extends BaseAPI {
     ...
     * Update delta token
     */
    markCrawlAsDeltaReset({ cMExternalMarkResetCrawl, aPIVersion }: MarkCrawlAsDeltaResetRequest): Observable<JsonMessage>
    markCrawlAsDeltaReset({ cMExternalMarkResetCrawl, aPIVersion }: MarkCrawlAsDeltaResetRequest, opts?: OperationOpts): Observable<AjaxResponse<JsonMessage>>
    markCrawlAsDeltaReset({ cMExternalMarkResetCrawl, aPIVersion }: MarkCrawlAsDeltaResetRequest, opts?: OperationOpts): Observable<JsonMessage | AjaxResponse<JsonMessage>> {
        throwIfNullOrUndefined(cMExternalMarkResetCrawl, 'cMExternalMarkResetCrawl', 'markCrawlAsDeltaReset');
        ...
        return this.request<JsonMessage>({
            url: '/api/crawler/external/crawler/mark-as-reset',
            method: 'POST',
            headers,
            body: cMExternalMarkResetCrawl,
        }, opts?.responseOpts);
    };
    ...
    /**
     */
    sync({ sessionId, cMSyncGDrive }: SyncRequest): Observable<object>
    sync({ sessionId, cMSyncGDrive }: SyncRequest, opts?: OperationOpts): Observable<AjaxResponse<object>>
    sync({ sessionId, cMSyncGDrive }: SyncRequest, opts?: OperationOpts): Observable<object | AjaxResponse<object>> {
        throwIfNullOrUndefined(sessionId, 'sessionId', 'sync');
        throwIfNullOrUndefined(cMSyncGDrive, 'cMSyncGDrive', 'sync');
        ...
        return this.request<object>({
            url: '/api/crawler/syncgdrivegroups',
            method: 'POST',
            headers,
            body: cMSyncGDrive,
        }, opts?.responseOpts);
 ...
 * @enum {string}
 */
export enum MarkCrawlAsDeltaResetAPIVersionEnum {
    _1 = '1'
}
/**
 * @export
