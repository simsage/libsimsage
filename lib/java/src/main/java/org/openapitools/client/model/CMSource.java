...
public class CMSource {
  ...
  public static final String SERIALIZED_NAME_QA_MATCH_STRENGTH = "qaMatchStrength";
  @SerializedName(SERIALIZED_NAME_QA_MATCH_STRENGTH)
  private Float qaMatchStrength;
  ...
  public static final String SERIALIZED_NAME_AUTO_OPTIMIZE = "autoOptimize";
  @SerializedName(SERIALIZED_NAME_AUTO_OPTIMIZE)
  ...
  **/
  ...
  public CMSource qaMatchStrength(Float qaMatchStrength) {
   ...
   * @return qaMatchStrength
  **/
  @javax.annotation.Nonnull
  public Float getQaMatchStrength() {
    return qaMatchStrength;
  }


  public void setQaMatchStrength(Float qaMatchStrength) {
    this.qaMatchStrength = qaMatchStrength;
  }
  ...
  **/
  ...
  public CMSource autoOptimize(Boolean autoOptimize) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceId, cmSource.sourceId) &&
        ...
        Objects.equals(this.qaMatchStrength, cmSource.qaMatchStrength) &&
        ...
        Objects.equals(this.autoOptimize, cmSource.autoOptimize) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organisationId, kbId, nodeId, name, crawlerType, schedule, deleteFiles, allowAnonymous, processingLevel, enablePreview, filesPerSecond, specificJson, sessionId, maxItems, maxBotItems, customRender, edgeDeviceId, qaMatchStrength, numResults, numFragments, numErrors, errorThreshold, startTime, endTime, acls, isCrawling, numCrawledDocuments, numConvertedDocuments, numParsedDocuments, numIndexedDocuments, numFinishedDocuments, numErroredDocuments, numTotalDocuments, numTotalErroredDocuments, useDefaultRelationships, isBusy, autoOptimize, storeBinary, versioned, writeToCassandra, processorConfig, enableDocumentSimilarity, documentSimilarityThreshold, isExternal, useOCR, useSTT, deltaIndicator, transmitExternalLogs, external, crawling, busy);
  }
  ...
  public String toString() {
    ...
    sb.append("    qaMatchStrength: ").append(toIndentedString(qaMatchStrength)).append("\n");
    ...
    sb.append("    autoOptimize: ").append(toIndentedString(autoOptimize)).append("\n");
  ...
  static {
    ...
    openapiFields.add("qaMatchStrength");
    ...
    openapiFields.add("autoOptimize");
    ...
    openapiRequiredFields.add("qaMatchStrength");
    ...
    openapiRequiredFields.add("autoOptimize");
