...
public class ApiClient {
    ...
    private String basePath = "https://test.simsage.ai";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://test.simsage.ai",
      "SimSage API",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/7.13.31/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://test.simsage.ai
