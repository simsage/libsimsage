...
public class ApiClient {
    ...
    private String basePath = "https://training.simsage.ai";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://training.simsage.ai",
      "SimSage API",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/7.14.12/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://training.simsage.ai
