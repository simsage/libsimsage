...
public class ApiClient {
    ...
    private String basePath = "https://demo.simsage.ai";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://demo.simsage.ai",
      "SimSage API",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/7.12.19/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://demo.simsage.ai
