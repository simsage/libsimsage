...
public class KnowledgeBase {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kbId, organisationId, name, email, securityId, created, maxQueriesPerDay, analyticsWindowInMonths, enabled, operatorEnabled, capacityWarnings, indexSchedule, lastIndexOptimizationTime, projectKb);
  }
