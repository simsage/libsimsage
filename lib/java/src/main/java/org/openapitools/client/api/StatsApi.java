...
public class StatsApi {
     ...
     * @param organisationId the organisation (its guid id) (required)
     * @param service the service to get the log for (required)
     * @param numLines the maximum number of lines to return if &gt; 0 (required)
     * @param sessionId a valid SimSage Session id. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call systemLogsCall(String organisationId, String service, Integer numLines, String sessionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/stats/system-logs/{organisationId}/{service}/{numLines}"
            .replace("{" + "organisationId" + "}", localVarApiClient.escapeString(organisationId.toString()))
            .replace("{" + "service" + "}", localVarApiClient.escapeString(service.toString()))
            .replace("{" + "numLines" + "}", localVarApiClient.escapeString(numLines.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call systemLogsValidateBeforeCall(String organisationId, String service, Integer numLines, String sessionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organisationId' is set
        if (organisationId == null) {
        ...
        if (service == null) {
            throw new ApiException("Missing the required parameter 'service' when calling systemLogs(Async)");
        }

        // verify the required parameter 'numLines' is set
        if (numLines == null) {
            throw new ApiException("Missing the required parameter 'numLines' when calling systemLogs(Async)");
        }
        ...
        return systemLogsCall(organisationId, service, numLines, sessionId, _callback);
     ...
     */
    public List<CMLoggerEntry> systemLogs(String organisationId, String service, Integer numLines, String sessionId) throws ApiException {
        ApiResponse<List<CMLoggerEntry>> localVarResp = systemLogsWithHttpInfo(organisationId, service, numLines, sessionId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<CMLoggerEntry>> systemLogsWithHttpInfo(String organisationId, String service, Integer numLines, String sessionId) throws ApiException {
        okhttp3.Call localVarCall = systemLogsValidateBeforeCall(organisationId, service, numLines, sessionId, null);
     ...
     */
    public okhttp3.Call systemLogsAsync(String organisationId, String service, Integer numLines, String sessionId, final ApiCallback<List<CMLoggerEntry>> _callback) throws ApiException {

        okhttp3.Call localVarCall = systemLogsValidateBeforeCall(organisationId, service, numLines, sessionId, _callback);
        Type localVarReturnType = new TypeToken<List<CMLoggerEntry>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
