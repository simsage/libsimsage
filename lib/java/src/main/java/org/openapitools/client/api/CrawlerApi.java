...
public class CrawlerApi {
    ...
    /**
     * Build call for crawlerExternalDocumentUnChanged
     * @param cmDocumentUnChanged  (required)
     * @param apIVersion  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> mark external-crawler document unchanged OK response </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> could not mark external-document as unchanged. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call crawlerExternalDocumentUnChangedCall(CMDocumentUnChanged cmDocumentUnChanged, String apIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = cmDocumentUnChanged;

        // create path and map variables
        String localVarPath = "/api/crawler/external/document/un-changed";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call crawlerExternalDocumentUnChangedValidateBeforeCall(CMDocumentUnChanged cmDocumentUnChanged, String apIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'cmDocumentUnChanged' is set
        if (cmDocumentUnChanged == null) {
            throw new ApiException("Missing the required parameter 'cmDocumentUnChanged' when calling crawlerExternalDocumentUnChanged(Async)");
        }

        return crawlerExternalDocumentUnChangedCall(cmDocumentUnChanged, apIVersion, _callback);
     ...
     */
    public JsonMessage crawlerExternalDocumentUnChanged(CMDocumentUnChanged cmDocumentUnChanged, String apIVersion) throws ApiException {
        ApiResponse<JsonMessage> localVarResp = crawlerExternalDocumentUnChangedWithHttpInfo(cmDocumentUnChanged, apIVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<JsonMessage> crawlerExternalDocumentUnChangedWithHttpInfo(CMDocumentUnChanged cmDocumentUnChanged, String apIVersion) throws ApiException {
        okhttp3.Call localVarCall = crawlerExternalDocumentUnChangedValidateBeforeCall(cmDocumentUnChanged, apIVersion, null);
        Type localVarReturnType = new TypeToken<JsonMessage>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Mark External Document Unchanged (asynchronously)
     * An external crawler document marks a document as not having changed.
     * @param cmDocumentUnChanged  (required)
     * @param apIVersion  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call crawlerExternalDocumentUnChangedAsync(CMDocumentUnChanged cmDocumentUnChanged, String apIVersion, final ApiCallback<JsonMessage> _callback) throws ApiException {

        okhttp3.Call localVarCall = crawlerExternalDocumentUnChangedValidateBeforeCall(cmDocumentUnChanged, apIVersion, _callback);
        Type localVarReturnType = new TypeToken<JsonMessage>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
