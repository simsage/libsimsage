...
import org.openapitools.client.model.CMExternalMarkResetCrawl;
...
import org.openapitools.client.model.CMSyncGDrive;
...
public class CrawlerApi {
    ...
    /**
     * Build call for markCrawlAsDeltaReset
     * @param cmExternalMarkResetCrawl  (required)
     * @param apIVersion  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 500 </td><td> could not mark source as reset requested. </td><td>  -  </td></tr>
        <tr><td> 200 </td><td> source delta-token reset OK response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call markCrawlAsDeltaResetCall(CMExternalMarkResetCrawl cmExternalMarkResetCrawl, String apIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = cmExternalMarkResetCrawl;

        // create path and map variables
        String localVarPath = "/api/crawler/external/crawler/mark-as-reset";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call markCrawlAsDeltaResetValidateBeforeCall(CMExternalMarkResetCrawl cmExternalMarkResetCrawl, String apIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'cmExternalMarkResetCrawl' is set
        if (cmExternalMarkResetCrawl == null) {
            throw new ApiException("Missing the required parameter 'cmExternalMarkResetCrawl' when calling markCrawlAsDeltaReset(Async)");
        }

        return markCrawlAsDeltaResetCall(cmExternalMarkResetCrawl, apIVersion, _callback);
     ...
     */
    public JsonMessage markCrawlAsDeltaReset(CMExternalMarkResetCrawl cmExternalMarkResetCrawl, String apIVersion) throws ApiException {
        ApiResponse<JsonMessage> localVarResp = markCrawlAsDeltaResetWithHttpInfo(cmExternalMarkResetCrawl, apIVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<JsonMessage> markCrawlAsDeltaResetWithHttpInfo(CMExternalMarkResetCrawl cmExternalMarkResetCrawl, String apIVersion) throws ApiException {
        okhttp3.Call localVarCall = markCrawlAsDeltaResetValidateBeforeCall(cmExternalMarkResetCrawl, apIVersion, null);
        Type localVarReturnType = new TypeToken<JsonMessage>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call markCrawlAsDeltaResetAsync(CMExternalMarkResetCrawl cmExternalMarkResetCrawl, String apIVersion, final ApiCallback<JsonMessage> _callback) throws ApiException {

        okhttp3.Call localVarCall = markCrawlAsDeltaResetValidateBeforeCall(cmExternalMarkResetCrawl, apIVersion, _callback);
        Type localVarReturnType = new TypeToken<JsonMessage>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call syncCall(String sessionId, CMSyncGDrive cmSyncGDrive, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = cmSyncGDrive;

        // create path and map variables
        String localVarPath = "/api/crawler/syncgdrivegroups";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call syncValidateBeforeCall(String sessionId, CMSyncGDrive cmSyncGDrive, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
            throw new ApiException("Missing the required parameter 'sessionId' when calling sync(Async)");
        }

        // verify the required parameter 'cmSyncGDrive' is set
        if (cmSyncGDrive == null) {
            throw new ApiException("Missing the required parameter 'cmSyncGDrive' when calling sync(Async)");
        }

        return syncCall(sessionId, cmSyncGDrive, _callback);
     ...
     */
    public Object sync(String sessionId, CMSyncGDrive cmSyncGDrive) throws ApiException {
        ApiResponse<Object> localVarResp = syncWithHttpInfo(sessionId, cmSyncGDrive);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> syncWithHttpInfo(String sessionId, CMSyncGDrive cmSyncGDrive) throws ApiException {
        okhttp3.Call localVarCall = syncValidateBeforeCall(sessionId, cmSyncGDrive, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call syncAsync(String sessionId, CMSyncGDrive cmSyncGDrive, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = syncValidateBeforeCall(sessionId, cmSyncGDrive, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
