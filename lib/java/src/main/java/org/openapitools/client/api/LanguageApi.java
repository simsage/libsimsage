...
public class LanguageApi {
    ...
    /**
     * Build call for optimizeIndexesAbort
     * @param sessionId a valid SimSage Session id. (required)
     * @param cmOptimizeIndex  (required)
     * @param apIVersion  (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call optimizeIndexesAbortCall(String sessionId, CMOptimizeIndex cmOptimizeIndex, String apIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/language/optimize-indexes-abort";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call optimizeIndexesAbortValidateBeforeCall(String sessionId, CMOptimizeIndex cmOptimizeIndex, String apIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
            throw new ApiException("Missing the required parameter 'sessionId' when calling optimizeIndexesAbort(Async)");
        }

        // verify the required parameter 'cmOptimizeIndex' is set
        if (cmOptimizeIndex == null) {
            throw new ApiException("Missing the required parameter 'cmOptimizeIndex' when calling optimizeIndexesAbort(Async)");
        }

        return optimizeIndexesAbortCall(sessionId, cmOptimizeIndex, apIVersion, _callback);
     ...
     */
    public JsonMessage optimizeIndexesAbort(String sessionId, CMOptimizeIndex cmOptimizeIndex, String apIVersion) throws ApiException {
        ApiResponse<JsonMessage> localVarResp = optimizeIndexesAbortWithHttpInfo(sessionId, cmOptimizeIndex, apIVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<JsonMessage> optimizeIndexesAbortWithHttpInfo(String sessionId, CMOptimizeIndex cmOptimizeIndex, String apIVersion) throws ApiException {
        okhttp3.Call localVarCall = optimizeIndexesAbortValidateBeforeCall(sessionId, cmOptimizeIndex, apIVersion, null);
        Type localVarReturnType = new TypeToken<JsonMessage>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Abort Index Optimization (asynchronously)
     * Force index optimizer to abort a job.
     * @param sessionId a valid SimSage Session id. (required)
     * @param cmOptimizeIndex  (required)
     * @param apIVersion  (optional)
     ...
     */
    public okhttp3.Call optimizeIndexesAbortAsync(String sessionId, CMOptimizeIndex cmOptimizeIndex, String apIVersion, final ApiCallback<JsonMessage> _callback) throws ApiException {

        okhttp3.Call localVarCall = optimizeIndexesAbortValidateBeforeCall(sessionId, cmOptimizeIndex, apIVersion, _callback);
        Type localVarReturnType = new TypeToken<JsonMessage>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
