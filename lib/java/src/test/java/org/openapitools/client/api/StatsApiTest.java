...
public class StatsApiTest {
     ...
     */
    @Test
    public void getIndexOptimzationReportTest() throws ApiException {
        String sessionId = null;
        String organisationId = null;
        String kbId = null;
        Long id = null;
        List<OptimizeIndexesGetReportCmd> response = api.getIndexOptimzationReport(sessionId, organisationId, kbId, id);
     ...
     */
    @Test
    public void getIndexOptimzationReportsTest() throws ApiException {
        String sessionId = null;
        String organisationId = null;
        String kbId = null;
        List<OptimizeIndexesGetReportsCmd> response = api.getIndexOptimzationReports(sessionId, organisationId, kbId);
        // TODO: test validations
    }
    ...
    public void systemLogsTest() throws ApiException {
        ...
        Integer hours = null;
        String sessionId = null;
        List<CMLoggerEntry> response = api.systemLogs(organisationId, year, month, day, hour, hours, sessionId);
        // TODO: test validations
    }
