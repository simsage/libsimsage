...
SimSage REST API
- API version: 7.12.19
  - Build date: 2024-03-06T16:21:46.672184776Z[Europe/London]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:7.12.19"
  }
```
...
* `target/openapi-java-client-7.12.19.jar`
* `target/lib/*.jar`
