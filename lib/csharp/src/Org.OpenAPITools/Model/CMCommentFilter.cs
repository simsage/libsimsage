...
namespace Org.OpenAPITools.Model
{
    ...
    /// CMCommentFilter
    /// </summary>
    [DataContract(Name = "CMCommentFilter")]
    public partial class CMCommentFilter : IEquatable<CMCommentFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CMCommentFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CMCommentFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CMCommentFilter" /> class.
        /// </summary>
        ...
        public CMCommentFilter(string organisationId = default(string), string projectId = default(string), string sliceId = default(string), string documentKey = default(string), string commentLevel = default(string))
        {
            // to ensure "organisationId" is required (not null)
            if (organisationId == null)
            {
                throw new ArgumentNullException("organisationId is a required property for CMCommentFilter and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "projectId" is required (not null)
            if (projectId == null)
            {
                throw new ArgumentNullException("projectId is a required property for CMCommentFilter and cannot be null");
            }
            this.ProjectId = projectId;
            // to ensure "sliceId" is required (not null)
            if (sliceId == null)
            {
                throw new ArgumentNullException("sliceId is a required property for CMCommentFilter and cannot be null");
            }
            this.SliceId = sliceId;
            // to ensure "documentKey" is required (not null)
            if (documentKey == null)
            {
                throw new ArgumentNullException("documentKey is a required property for CMCommentFilter and cannot be null");
            }
            this.DocumentKey = documentKey;
            // to ensure "commentLevel" is required (not null)
            if (commentLevel == null)
            {
                throw new ArgumentNullException("commentLevel is a required property for CMCommentFilter and cannot be null");
            }
        ...
        {
            return this.Equals(input as CMCommentFilter);
        }

        /// <summary>
        /// Returns true if CMCommentFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of CMCommentFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CMCommentFilter input)
        {
            if (input == null)
            {
                return false;
