...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMFailedSourceDocument : IEquatable<CMFailedSourceDocument>, IValidatableObject
    {
        ...
        public CMFailedSourceDocument(string organisationId = default(string), string kbId = default(string), int sourceId = default(int), string sourceSystemId = default(string), string webUrl = default(string), long runId = default(long), string errorMessage = default(string), bool encrypted = default(bool), int seed = default(int), string sid = default(string))
        {
