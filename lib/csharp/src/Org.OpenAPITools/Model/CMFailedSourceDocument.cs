...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMFailedSourceDocument : IEquatable<CMFailedSourceDocument>, IValidatableObject
    {
        ...
        /// <param name="deltaRootId">For delta crawlers with multiple roots, the id of the document&#39;s delta root (required).</param>
        /// <param name="runId">the timestamp of the crawler run adding the exception (required).</param>
        ...
        public CMFailedSourceDocument(string organisationId = default(string), string kbId = default(string), int sourceId = default(int), string sourceSystemId = default(string), string webUrl = default(string), string deltaRootId = default(string), long runId = default(long), string errorMessage = default(string), bool encrypted = default(bool), int seed = default(int), string sid = default(string))
        {
            ...
            this.WebUrl = webUrl;
            // to ensure "deltaRootId" is required (not null)
            if (deltaRootId == null)
            {
                throw new ArgumentNullException("deltaRootId is a required property for CMFailedSourceDocument and cannot be null");
            }
            this.DeltaRootId = deltaRootId;
            this.RunId = runId;
        ...
        /// </summary>
        /// <value>For delta crawlers with multiple roots, the id of the document&#39;s delta root</value>
        /// <example>1234567</example>
        [DataMember(Name = "deltaRootId", IsRequired = true, EmitDefaultValue = true)]
        public string DeltaRootId { get; set; }

        /// <summary>
        /// the timestamp of the crawler run adding the exception
        /// </summary>
        /// <value>the timestamp of the crawler run adding the exception</value>
        /// <example>1234567</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeltaRootId: ").Append(DeltaRootId).Append("\n");
        ...
        public bool Equals(CMFailedSourceDocument input)
        {
            ...
            return 
                ...
                (
                    this.DeltaRootId == input.DeltaRootId ||
                    (this.DeltaRootId != null &&
                    this.DeltaRootId.Equals(input.DeltaRootId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeltaRootId != null)
                {
                    hashCode = (hashCode * 59) + this.DeltaRootId.GetHashCode();
                }
