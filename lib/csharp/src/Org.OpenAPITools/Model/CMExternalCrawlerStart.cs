...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMExternalCrawlerStart : IEquatable<CMExternalCrawlerStart>, IValidatableObject
    {
        ...
        public CMExternalCrawlerStart(string objectType = default(string), string organisationId = default(string), string kbId = default(string), string sid = default(string), int sourceId = default(int), long runId = default(long), bool encrypted = default(bool), int seed = default(int))
        {
