...
namespace Org.OpenAPITools.Model
{
    ...
    /// Start parameters.
    /// </summary>
    [DataContract(Name = "CMExternalCrawlerStart")]
    public partial class CMExternalCrawlerStart : IEquatable<CMExternalCrawlerStart>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawlerStart" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CMExternalCrawlerStart() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawlerStart" /> class.
        /// </summary>
        ...
        public CMExternalCrawlerStart(string objectType = default(string), string organisationId = default(string), string kbId = default(string), string sid = default(string), int sourceId = default(int), string runId = default(string), bool encrypted = default(bool), int seed = default(int))
        {
            // to ensure "objectType" is required (not null)
            if (objectType == null)
            {
                throw new ArgumentNullException("objectType is a required property for CMExternalCrawlerStart and cannot be null");
            }
            this.ObjectType = objectType;
            // to ensure "organisationId" is required (not null)
            if (organisationId == null)
            {
                throw new ArgumentNullException("organisationId is a required property for CMExternalCrawlerStart and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "kbId" is required (not null)
            if (kbId == null)
            {
                throw new ArgumentNullException("kbId is a required property for CMExternalCrawlerStart and cannot be null");
            }
            this.KbId = kbId;
            // to ensure "sid" is required (not null)
            if (sid == null)
            {
                throw new ArgumentNullException("sid is a required property for CMExternalCrawlerStart and cannot be null");
            }
            this.Sid = sid;
            ...
            if (runId == null)
            {
                throw new ArgumentNullException("runId is a required property for CMExternalCrawlerStart and cannot be null");
            }
            this.RunId = runId;
        ...
        {
            return this.Equals(input as CMExternalCrawlerStart);
        }

        /// <summary>
        /// Returns true if CMExternalCrawlerStart instances are equal
        /// </summary>
        /// <param name="input">Instance of CMExternalCrawlerStart to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CMExternalCrawlerStart input)
        {
            if (input == null)
            {
                return false;
