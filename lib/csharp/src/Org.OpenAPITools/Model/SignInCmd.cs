...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SignInCmd : IEquatable<SignInCmd>, IValidatableObject
    {
        ...
        public SignInCmd(List<Organisation> organisationList = default(List<Organisation>), string jobId = default(string), string returnAddress = default(string), string errorStr = default(string), long timeOut = default(long), bool async = default(bool), bool isReturnResult = default(bool), string email = default(string), string password = default(string), List<string> roles = default(List<string>), string remoteAddress = default(string), Session session = default(Session), User user = default(User), string organisationId = default(string), bool returnResult = default(bool))
        {
