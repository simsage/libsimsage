...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMUserWithExtras : IEquatable<CMUserWithExtras>, IValidatableObject
    {
        ...
        public CMUserWithExtras(string id = default(string), string email = default(string), string password = default(string), string firstName = default(string), string surname = default(string), string roles = default(string), string operatorKBList = default(string), List<CMGroup> groupList = default(List<CMGroup>), string jwtMatchNameValueCSV = default(string))
        {
            ...
            {
                throw new ArgumentNullException("jwtMatchNameValueCSV is a required property for CMUserWithExtras and cannot be null");
            }
