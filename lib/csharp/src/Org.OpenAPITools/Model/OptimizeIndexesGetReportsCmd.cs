...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OptimizeIndexesGetReportsCmd")]
    public partial class OptimizeIndexesGetReportsCmd : IEquatable<OptimizeIndexesGetReportsCmd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizeIndexesGetReportsCmd" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptimizeIndexesGetReportsCmd() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizeIndexesGetReportsCmd" /> class.
        /// </summary>
        ...
        /// <param name="reportList">reportList (required).</param>
        /// <param name="returnResult">returnResult.</param>
        public OptimizeIndexesGetReportsCmd(string jobId = default(string), string returnAddress = default(string), string errorStr = default(string), long timeOut = default(long), bool async = default(bool), bool isReturnResult = default(bool), string organisationId = default(string), string kbId = default(string), List<long> reportList = default(List<long>), bool returnResult = default(bool))
        {
            // to ensure "jobId" is required (not null)
            if (jobId == null)
            {
                throw new ArgumentNullException("jobId is a required property for OptimizeIndexesGetReportsCmd and cannot be null");
            }
            this.JobId = jobId;
            // to ensure "returnAddress" is required (not null)
            if (returnAddress == null)
            {
                throw new ArgumentNullException("returnAddress is a required property for OptimizeIndexesGetReportsCmd and cannot be null");
            }
            this.ReturnAddress = returnAddress;
            // to ensure "errorStr" is required (not null)
            if (errorStr == null)
            {
                throw new ArgumentNullException("errorStr is a required property for OptimizeIndexesGetReportsCmd and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("organisationId is a required property for OptimizeIndexesGetReportsCmd and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "kbId" is required (not null)
            if (kbId == null)
            {
                throw new ArgumentNullException("kbId is a required property for OptimizeIndexesGetReportsCmd and cannot be null");
            }
            this.KbId = kbId;
            // to ensure "reportList" is required (not null)
            if (reportList == null)
            {
                throw new ArgumentNullException("reportList is a required property for OptimizeIndexesGetReportsCmd and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets ReportList
        /// </summary>
        [DataMember(Name = "reportList", IsRequired = true, EmitDefaultValue = true)]
        public List<long> ReportList { get; set; }
        ...
        {
            return this.Equals(input as OptimizeIndexesGetReportsCmd);
        }

        /// <summary>
        /// Returns true if OptimizeIndexesGetReportsCmd instances are equal
        /// </summary>
        /// <param name="input">Instance of OptimizeIndexesGetReportsCmd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptimizeIndexesGetReportsCmd input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ReportList == input.ReportList ||
                    this.ReportList != null &&
                    input.ReportList != null &&
                    this.ReportList.SequenceEqual(input.ReportList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ReportList.GetHashCode();
                }
