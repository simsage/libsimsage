...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMKnowledgeBase : IEquatable<CMKnowledgeBase>, IValidatableObject
    {
        ...
        /// <param name="isOptimizing">is the index optimizer active? (required).</param>
        /// <param name="optimizationProgress">how far along is the optimizer if it is active (0% to 100%) (required).</param>
        /// <param name="optimizing">optimizing.</param>
        public CMKnowledgeBase(string organisationId = default(string), string kbId = default(string), string name = default(string), string email = default(string), string securityId = default(string), long created = default(long), long maxQueriesPerDay = default(long), int analyticsWindowInMonths = default(int), bool enabled = default(bool), bool operatorEnabled = default(bool), bool capacityWarnings = default(bool), string indexSchedule = default(string), long lastIndexOptimizationTime = default(long), bool isOptimizing = default(bool), int optimizationProgress = default(int), bool optimizing = default(bool))
        {
        ...
        /// </summary>
        /// <value>is the index optimizer active?</value>
        ...
        /// </summary>
        /// <value>how far along is the optimizer if it is active (0% to 100%)</value>
        /// <example>75</example>
