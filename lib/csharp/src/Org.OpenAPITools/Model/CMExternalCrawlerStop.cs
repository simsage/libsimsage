...
namespace Org.OpenAPITools.Model
{
    ...
    /// Stop parameters.
    /// </summary>
    [DataContract(Name = "CMExternalCrawlerStop")]
    public partial class CMExternalCrawlerStop : IEquatable<CMExternalCrawlerStop>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawlerStop" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CMExternalCrawlerStop() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawlerStop" /> class.
        /// </summary>
        ...
        /// <param name="numErrors">the number of errors encountered during the run of this crawler (required).</param>
        /// <param name="numFilesSeen">the number of files seen during the run of this crawler (required).</param>
        ...
        public CMExternalCrawlerStop(string objectType = default(string), string organisationId = default(string), string kbId = default(string), string sid = default(string), int sourceId = default(int), int numErrors = default(int), long numFilesSeen = default(long), long runId = default(long), bool encrypted = default(bool), int seed = default(int))
        {
            // to ensure "objectType" is required (not null)
            if (objectType == null)
            {
                throw new ArgumentNullException("objectType is a required property for CMExternalCrawlerStop and cannot be null");
            }
            this.ObjectType = objectType;
            // to ensure "organisationId" is required (not null)
            if (organisationId == null)
            {
                throw new ArgumentNullException("organisationId is a required property for CMExternalCrawlerStop and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "kbId" is required (not null)
            if (kbId == null)
            {
                throw new ArgumentNullException("kbId is a required property for CMExternalCrawlerStop and cannot be null");
            }
            this.KbId = kbId;
            // to ensure "sid" is required (not null)
            if (sid == null)
            {
                throw new ArgumentNullException("sid is a required property for CMExternalCrawlerStop and cannot be null");
            }
            this.Sid = sid;
        ...
        /// <example>CMExternalCrawlerStartStop</example>
        ...
        /// </summary>
        /// <value>the number of errors encountered during the run of this crawler</value>
        /// <example>0</example>
        ...
        /// </summary>
        /// <value>the number of files seen during the run of this crawler</value>
        /// <example>0</example>
        [DataMember(Name = "numFilesSeen", IsRequired = true, EmitDefaultValue = true)]
        public long NumFilesSeen { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NumFilesSeen: ").Append(NumFilesSeen).Append("\n");
        ...
        {
            return this.Equals(input as CMExternalCrawlerStop);
        }

        /// <summary>
        /// Returns true if CMExternalCrawlerStop instances are equal
        /// </summary>
        /// <param name="input">Instance of CMExternalCrawlerStop to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CMExternalCrawlerStop input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.NumFilesSeen == input.NumFilesSeen ||
                    this.NumFilesSeen.Equals(input.NumFilesSeen)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.NumFilesSeen.GetHashCode();
