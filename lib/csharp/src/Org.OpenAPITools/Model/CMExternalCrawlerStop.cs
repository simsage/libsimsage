...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMExternalCrawlerStop : IEquatable<CMExternalCrawlerStop>, IValidatableObject
    {
        ...
        public CMExternalCrawlerStop(string objectType = default(string), string organisationId = default(string), string kbId = default(string), string sid = default(string), int sourceId = default(int), int numErrors = default(int), string runId = default(string), bool encrypted = default(bool), int seed = default(int))
        {
            ...
            if (runId == null)
            {
                throw new ArgumentNullException("runId is a required property for CMExternalCrawlerStop and cannot be null");
            }
            this.RunId = runId;
