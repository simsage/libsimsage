...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CMExternalCrawlerSetDeltaToken")]
    public partial class CMExternalCrawlerSetDeltaToken : IEquatable<CMExternalCrawlerSetDeltaToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawlerSetDeltaToken" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CMExternalCrawlerSetDeltaToken() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawlerSetDeltaToken" /> class.
        /// </summary>
        ...
        /// <param name="deltaToken">the delta-token to set. (required).</param>
        ...
        public CMExternalCrawlerSetDeltaToken(string objectType = default(string), string organisationId = default(string), string kbId = default(string), string sid = default(string), int sourceId = default(int), string deltaToken = default(string), bool encrypted = default(bool), int seed = default(int))
        {
            // to ensure "objectType" is required (not null)
            if (objectType == null)
            {
                throw new ArgumentNullException("objectType is a required property for CMExternalCrawlerSetDeltaToken and cannot be null");
            }
            this.ObjectType = objectType;
            // to ensure "organisationId" is required (not null)
            if (organisationId == null)
            {
                throw new ArgumentNullException("organisationId is a required property for CMExternalCrawlerSetDeltaToken and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "kbId" is required (not null)
            if (kbId == null)
            {
                throw new ArgumentNullException("kbId is a required property for CMExternalCrawlerSetDeltaToken and cannot be null");
            }
            this.KbId = kbId;
            // to ensure "sid" is required (not null)
            if (sid == null)
            {
                throw new ArgumentNullException("sid is a required property for CMExternalCrawlerSetDeltaToken and cannot be null");
            }
            this.Sid = sid;
            this.SourceId = sourceId;
            // to ensure "deltaToken" is required (not null)
            if (deltaToken == null)
            {
                throw new ArgumentNullException("deltaToken is a required property for CMExternalCrawlerSetDeltaToken and cannot be null");
            }
        ...
        /// <example>CMExternalCrawlerSetDeltaToken</example>
        ...
        /// </summary>
        /// <value>the delta-token to set.</value>
        [DataMember(Name = "deltaToken", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as CMExternalCrawlerSetDeltaToken);
        }

        /// <summary>
        /// Returns true if CMExternalCrawlerSetDeltaToken instances are equal
        /// </summary>
        /// <param name="input">Instance of CMExternalCrawlerSetDeltaToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CMExternalCrawlerSetDeltaToken input)
        {
            if (input == null)
            {
                return false;
