...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Asset : IEquatable<Asset>, IValidatableObject
    {
        ...
        /// <param name="deltaRootId">deltaRootId (required).</param>
        ...
        public Asset(string url = default(string), string parentUrl = default(string), string mimeType = default(string), List<AssetACL> acls = default(List<AssetACL>), string deltaRootId = default(string), string title = default(string), string author = default(string), long binarySize = default(long), string template = default(string), long created = default(long), long lastModified = default(long), Dictionary<string, string> metadata = default(Dictionary<string, string>), byte[] data = default(byte[]), byte[] previewImage = default(byte[]))
        {
            ...
            if (deltaRootId == null)
            {
                throw new ArgumentNullException("deltaRootId is a required property for Asset and cannot be null");
            }
