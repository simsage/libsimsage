...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SignInAdmin : IEquatable<SignInAdmin>, IValidatableObject
    {
        ...
        /// <param name="sharedSecretSalt">sharedSecretSalt (required).</param>
        ...
        public SignInAdmin(List<Organisation> organisationList = default(List<Organisation>), string sharedSecretSalt = default(string), string jobId = default(string), string returnAddress = default(string), string errorStr = default(string), long timeOut = default(long), bool async = default(bool), bool isReturnResult = default(bool), string email = default(string), string password = default(string), List<string> roles = default(List<string>), string remoteAddress = default(string), Session session = default(Session), User user = default(User), string organisationId = default(string), bool returnResult = default(bool))
        {
            ...
            // to ensure "sharedSecretSalt" is required (not null)
            if (sharedSecretSalt == null)
            {
                throw new ArgumentNullException("sharedSecretSalt is a required property for SignInAdmin and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets SharedSecretSalt
        /// </summary>
        [DataMember(Name = "sharedSecretSalt", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SharedSecretSalt: ").Append(SharedSecretSalt).Append("\n");
        ...
        public bool Equals(SignInAdmin input)
        {
            ...
            return 
                ...
                (
                    this.SharedSecretSalt == input.SharedSecretSalt ||
                    (this.SharedSecretSalt != null &&
                    this.SharedSecretSalt.Equals(input.SharedSecretSalt))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SharedSecretSalt != null)
                {
                    hashCode = (hashCode * 59) + this.SharedSecretSalt.GetHashCode();
                }
                if (this.JobId != null)
                {
