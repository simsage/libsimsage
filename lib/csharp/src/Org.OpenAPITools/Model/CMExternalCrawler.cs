...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CMExternalCrawler")]
    public partial class CMExternalCrawler : IEquatable<CMExternalCrawler>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawler" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CMExternalCrawler() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawler" /> class.
        /// </summary>
        ...
        public CMExternalCrawler(string objectType = default(string), string organisationId = default(string), string kbId = default(string), string sid = default(string), int sourceId = default(int), bool encrypted = default(bool), int seed = default(int))
        {
            // to ensure "objectType" is required (not null)
            if (objectType == null)
            {
                throw new ArgumentNullException("objectType is a required property for CMExternalCrawler and cannot be null");
            }
            this.ObjectType = objectType;
            // to ensure "organisationId" is required (not null)
            if (organisationId == null)
            {
                throw new ArgumentNullException("organisationId is a required property for CMExternalCrawler and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "kbId" is required (not null)
            if (kbId == null)
            {
                throw new ArgumentNullException("kbId is a required property for CMExternalCrawler and cannot be null");
            }
            this.KbId = kbId;
            // to ensure "sid" is required (not null)
            if (sid == null)
            {
                throw new ArgumentNullException("sid is a required property for CMExternalCrawler and cannot be null");
            }
            this.Sid = sid;
        ...
        /// <example>CMExternalCrawler</example>
        ...
        {
            return this.Equals(input as CMExternalCrawler);
        }

        /// <summary>
        /// Returns true if CMExternalCrawler instances are equal
        /// </summary>
        /// <param name="input">Instance of CMExternalCrawler to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CMExternalCrawler input)
        {
            if (input == null)
            {
                return false;
