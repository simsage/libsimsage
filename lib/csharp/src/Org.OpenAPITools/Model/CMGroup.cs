...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMGroup : IEquatable<CMGroup>, IValidatableObject
    {
        ...
        /// <param name="originalName">the original-name of this group to help rename the group (required).</param>
        /// <param name="userIdList">a list of user-ids (can be empty) part of this group (required).</param>
        public CMGroup(string organisationId = default(string), string name = default(string), string originalName = default(string), List<string> userIdList = default(List<string>))
        {
            ...
            {
                throw new ArgumentNullException("originalName is a required property for CMGroup and cannot be null");
            }
        ...
        /// </summary>
        /// <value>the original-name of this group to help rename the group</value>
        /// <example>Domain Users</example>
