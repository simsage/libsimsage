...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMSource : IEquatable<CMSource>, IValidatableObject
    {
        ...
        /// <param name="filesPerSecond">Any value greater than 0.0 (can be fractional) indicates SimSage should limit how many requests it makes from the remote entity we&#39;re integrating with. (required).</param>
        ...
        /// <param name="qaMatchStrength">the default threshold for matching deep-learning vector matching results (value should be between 0.7 and 0.99) (required).</param>
        ...
        /// <param name="autoOptimize">Do we run the index-optimizer automatically after this source finishes crawling? (required).</param>
        ...
        public CMSource(int sourceId = default(int), string organisationId = default(string), string kbId = default(string), int nodeId = default(int), string name = default(string), string crawlerType = default(string), string schedule = default(string), bool deleteFiles = default(bool), bool allowAnonymous = default(bool), string processingLevel = default(string), bool enablePreview = default(bool), float filesPerSecond = default(float), string specificJson = default(string), string sessionId = default(string), long maxItems = default(long), long maxBotItems = default(long), bool customRender = default(bool), string edgeDeviceId = default(string), float qaMatchStrength = default(float), int numResults = default(int), int numFragments = default(int), int numErrors = default(int), int errorThreshold = default(int), long startTime = default(long), long endTime = default(long), List<CMDocumentAcl> acls = default(List<CMDocumentAcl>), bool isCrawling = default(bool), int numCrawledDocuments = default(int), int numConvertedDocuments = default(int), int numParsedDocuments = default(int), int numIndexedDocuments = default(int), int numFinishedDocuments = default(int), int numTotalDocuments = default(int), bool useDefaultRelationships = default(bool), bool isBusy = default(bool), bool autoOptimize = default(bool), bool storeBinary = default(bool), bool versioned = default(bool), bool writeToCassandra = default(bool), string processorConfig = default(string), bool enableDocumentSimilarity = default(bool), float documentSimilarityThreshold = default(float), bool isExternal = default(bool), bool useOCR = default(bool), bool useSTT = default(bool), bool external = default(bool), bool crawling = default(bool), bool busy = default(bool))
        {
            ...
            this.QaMatchStrength = qaMatchStrength;
        ...
        /// </summary>
        /// <value>Any value greater than 0.0 (can be fractional) indicates SimSage should limit how many requests it makes from the remote entity we&#39;re integrating with.</value>
        /// <example>0.0</example>
        ...
        /// </summary>
        /// <value>the default threshold for matching deep-learning vector matching results (value should be between 0.7 and 0.99)</value>
        [DataMember(Name = "qaMatchStrength", IsRequired = true, EmitDefaultValue = true)]
        public float QaMatchStrength { get; set; }
        ...
        /// </summary>
        /// <value>Do we run the index-optimizer automatically after this source finishes crawling?</value>
        /// <example>false</example>
        [DataMember(Name = "autoOptimize", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  QaMatchStrength: ").Append(QaMatchStrength).Append("\n");
            ...
            sb.Append("  AutoOptimize: ").Append(AutoOptimize).Append("\n");
        ...
        public bool Equals(CMSource input)
        {
            ...
            return 
                ...
                (
                    this.QaMatchStrength == input.QaMatchStrength ||
                    this.QaMatchStrength.Equals(input.QaMatchStrength)
                ) && 
                (
                ...
                (
                    this.AutoOptimize == input.AutoOptimize ||
                    this.AutoOptimize.Equals(input.AutoOptimize)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.QaMatchStrength.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.AutoOptimize.GetHashCode();
