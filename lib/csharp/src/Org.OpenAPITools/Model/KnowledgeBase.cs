...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class KnowledgeBase : IEquatable<KnowledgeBase>, IValidatableObject
    {
        ...
        /// <param name="isOptimizing">isOptimizing (required).</param>
        /// <param name="optimizationProgress">optimizationProgress (required).</param>
        /// <param name="optimizing">optimizing.</param>
        public KnowledgeBase(string kbId = default(string), string organisationId = default(string), string name = default(string), string email = default(string), string securityId = default(string), long created = default(long), long maxQueriesPerDay = default(long), int analyticsWindowInMonths = default(int), bool enabled = default(bool), bool operatorEnabled = default(bool), bool capacityWarnings = default(bool), string indexSchedule = default(string), long lastIndexOptimizationTime = default(long), bool projectKb = default(bool), bool isOptimizing = default(bool), int optimizationProgress = default(int), bool optimizing = default(bool))
        {
        ...
        /// <summary>
        /// Gets or Sets IsOptimizing
        /// </summary>
        [DataMember(Name = "isOptimizing", IsRequired = true, EmitDefaultValue = true)]
        public bool IsOptimizing { get; set; }

        /// <summary>
        /// Gets or Sets OptimizationProgress
        /// </summary>
        [DataMember(Name = "optimizationProgress", IsRequired = true, EmitDefaultValue = true)]
        public int OptimizationProgress { get; set; }

        /// <summary>
        /// Gets or Sets Optimizing
        /// </summary>
        [DataMember(Name = "optimizing", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsOptimizing: ").Append(IsOptimizing).Append("\n");
            sb.Append("  OptimizationProgress: ").Append(OptimizationProgress).Append("\n");
            sb.Append("  Optimizing: ").Append(Optimizing).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(KnowledgeBase input)
        {
            ...
            return 
                ...
                (
                    this.IsOptimizing == input.IsOptimizing ||
                    this.IsOptimizing.Equals(input.IsOptimizing)
                ) && 
                (
                    this.OptimizationProgress == input.OptimizationProgress ||
                    this.OptimizationProgress.Equals(input.OptimizationProgress)
                ) && 
                (
                    this.Optimizing == input.Optimizing ||
                    this.Optimizing.Equals(input.Optimizing)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IsOptimizing.GetHashCode();
                hashCode = (hashCode * 59) + this.OptimizationProgress.GetHashCode();
                hashCode = (hashCode * 59) + this.Optimizing.GetHashCode();
                return hashCode;
            }
        }
