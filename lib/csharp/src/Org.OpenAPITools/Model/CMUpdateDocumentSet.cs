...
namespace Org.OpenAPITools.Model
{
    ...
    /// CMUpdateDocumentSet
    /// </summary>
    [DataContract(Name = "CMUpdateDocumentSet")]
    public partial class CMUpdateDocumentSet : IEquatable<CMUpdateDocumentSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CMUpdateDocumentSet" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CMUpdateDocumentSet() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CMUpdateDocumentSet" /> class.
        /// </summary>
        /// <param name="organisationId">organisationId (required).</param>
        /// <param name="kbId">kbId (required).</param>
        /// <param name="projectDetails">projectDetails (required).</param>
        ...
        public CMUpdateDocumentSet(string organisationId = default(string), string kbId = default(string), GdprProject projectDetails = default(GdprProject), string jobId = default(string), string returnAddress = default(string), string errorStr = default(string), long timeOut = default(long), bool async = default(bool), bool isReturnResult = default(bool), bool returnResult = default(bool))
        {
            // to ensure "organisationId" is required (not null)
            if (organisationId == null)
            {
                throw new ArgumentNullException("organisationId is a required property for CMUpdateDocumentSet and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "kbId" is required (not null)
            if (kbId == null)
            {
                throw new ArgumentNullException("kbId is a required property for CMUpdateDocumentSet and cannot be null");
            }
            this.KbId = kbId;
            // to ensure "projectDetails" is required (not null)
            if (projectDetails == null)
            {
                throw new ArgumentNullException("projectDetails is a required property for CMUpdateDocumentSet and cannot be null");
            }
            this.ProjectDetails = projectDetails;
            // to ensure "jobId" is required (not null)
            if (jobId == null)
            {
                throw new ArgumentNullException("jobId is a required property for CMUpdateDocumentSet and cannot be null");
            }
            this.JobId = jobId;
            // to ensure "returnAddress" is required (not null)
            if (returnAddress == null)
            {
                throw new ArgumentNullException("returnAddress is a required property for CMUpdateDocumentSet and cannot be null");
            }
            this.ReturnAddress = returnAddress;
            // to ensure "errorStr" is required (not null)
            if (errorStr == null)
            {
                throw new ArgumentNullException("errorStr is a required property for CMUpdateDocumentSet and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "projectDetails", IsRequired = true, EmitDefaultValue = true)]
        public GdprProject ProjectDetails { get; set; }
        ...
        {
            return this.Equals(input as CMUpdateDocumentSet);
        }

        /// <summary>
        /// Returns true if CMUpdateDocumentSet instances are equal
        /// </summary>
        /// <param name="input">Instance of CMUpdateDocumentSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CMUpdateDocumentSet input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProjectDetails == input.ProjectDetails ||
                    (this.ProjectDetails != null &&
                    this.ProjectDetails.Equals(input.ProjectDetails))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ProjectDetails.GetHashCode();
                }
                if (this.JobId != null)
                {
