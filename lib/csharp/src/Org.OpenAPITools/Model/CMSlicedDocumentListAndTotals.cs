...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMSlicedDocumentListAndTotals : IEquatable<CMSlicedDocumentListAndTotals>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets Quarantined
        /// </summary>
        [DataMember(Name = "quarantined", IsRequired = true, EmitDefaultValue = true)]
        ...
        public bool Equals(CMSlicedDocumentListAndTotals input)
        {
            ...
            return 
                ...
                (
                    this.Quarantined == input.Quarantined ||
                    this.Quarantined.Equals(input.Quarantined)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.Quarantined.GetHashCode();
