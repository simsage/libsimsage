...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CMExternalCrawlerMarkFileAsSeen")]
    public partial class CMExternalCrawlerMarkFileAsSeen : IEquatable<CMExternalCrawlerMarkFileAsSeen>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawlerMarkFileAsSeen" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CMExternalCrawlerMarkFileAsSeen() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CMExternalCrawlerMarkFileAsSeen" /> class.
        /// </summary>
        ...
        public CMExternalCrawlerMarkFileAsSeen(string objectType = default(string), string organisationId = default(string), string kbId = default(string), string sid = default(string), int sourceId = default(int), Asset asset = default(Asset), bool encrypted = default(bool), int seed = default(int))
        {
            // to ensure "objectType" is required (not null)
            if (objectType == null)
            {
                throw new ArgumentNullException("objectType is a required property for CMExternalCrawlerMarkFileAsSeen and cannot be null");
            }
            this.ObjectType = objectType;
            // to ensure "organisationId" is required (not null)
            if (organisationId == null)
            {
                throw new ArgumentNullException("organisationId is a required property for CMExternalCrawlerMarkFileAsSeen and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "kbId" is required (not null)
            if (kbId == null)
            {
                throw new ArgumentNullException("kbId is a required property for CMExternalCrawlerMarkFileAsSeen and cannot be null");
            }
            this.KbId = kbId;
            // to ensure "sid" is required (not null)
            if (sid == null)
            {
                throw new ArgumentNullException("sid is a required property for CMExternalCrawlerMarkFileAsSeen and cannot be null");
            }
            this.Sid = sid;
            ...
            if (asset == null)
            {
                throw new ArgumentNullException("asset is a required property for CMExternalCrawlerMarkFileAsSeen and cannot be null");
            }
            this.Asset = asset;
        ...
        {
            return this.Equals(input as CMExternalCrawlerMarkFileAsSeen);
        }

        /// <summary>
        /// Returns true if CMExternalCrawlerMarkFileAsSeen instances are equal
        /// </summary>
        /// <param name="input">Instance of CMExternalCrawlerMarkFileAsSeen to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CMExternalCrawlerMarkFileAsSeen input)
        {
            if (input == null)
            {
                return false;
