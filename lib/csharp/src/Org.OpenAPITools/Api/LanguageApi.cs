...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ILanguageApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>JsonMessage</returns>
        JsonMessage OptimizeIndexesAbort(string sessionId, CMOptimizeIndex cMOptimizeIndex, string? aPIVersion = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of JsonMessage</returns>
        ApiResponse<JsonMessage> OptimizeIndexesAbortWithHttpInfo(string sessionId, CMOptimizeIndex cMOptimizeIndex, string? aPIVersion = default(string?), int operationIndex = 0);
        /// <summary>
        /// Redact Document
        /// </summary>
        /// <remarks>
    ...
    public interface ILanguageApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of JsonMessage</returns>
        System.Threading.Tasks.Task<JsonMessage> OptimizeIndexesAbortAsync(string sessionId, CMOptimizeIndex cMOptimizeIndex, string? aPIVersion = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (JsonMessage)</returns>
        System.Threading.Tasks.Task<ApiResponse<JsonMessage>> OptimizeIndexesAbortWithHttpInfoAsync(string sessionId, CMOptimizeIndex cMOptimizeIndex, string? aPIVersion = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Redact Document
        /// </summary>
        /// <remarks>
    ...
    public partial class LanguageApi : ILanguageApi
    {
        ...
        /// <summary>
        /// Abort Index Optimization Force index optimizer to abort a job.
        /// </summary>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sessionId">a valid SimSage Session id.</param>
        /// <param name="cMOptimizeIndex"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>JsonMessage</returns>
        public JsonMessage OptimizeIndexesAbort(string sessionId, CMOptimizeIndex cMOptimizeIndex, string? aPIVersion = default(string?), int operationIndex = 0)
        {
            Org.OpenAPITools.Client.ApiResponse<JsonMessage> localVarResponse = OptimizeIndexesAbortWithHttpInfo(sessionId, cMOptimizeIndex, aPIVersion);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of JsonMessage</returns>
        public Org.OpenAPITools.Client.ApiResponse<JsonMessage> OptimizeIndexesAbortWithHttpInfo(string sessionId, CMOptimizeIndex cMOptimizeIndex, string? aPIVersion = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'sessionId' when calling LanguageApi->OptimizeIndexesAbort");
            }

            // verify the required parameter 'cMOptimizeIndex' is set
            if (cMOptimizeIndex == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'cMOptimizeIndex' when calling LanguageApi->OptimizeIndexesAbort");
            }
            ...
            localVarRequestOptions.Operation = "LanguageApi.OptimizeIndexesAbort";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Put<JsonMessage>("/api/language/optimize-indexes-abort", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("OptimizeIndexesAbort", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of JsonMessage</returns>
        public async System.Threading.Tasks.Task<JsonMessage> OptimizeIndexesAbortAsync(string sessionId, CMOptimizeIndex cMOptimizeIndex, string? aPIVersion = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Org.OpenAPITools.Client.ApiResponse<JsonMessage> localVarResponse = await OptimizeIndexesAbortWithHttpInfoAsync(sessionId, cMOptimizeIndex, aPIVersion, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (JsonMessage)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<JsonMessage>> OptimizeIndexesAbortWithHttpInfoAsync(string sessionId, CMOptimizeIndex cMOptimizeIndex, string? aPIVersion = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'sessionId' is set
            if (sessionId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<JsonMessage>("/api/language/optimize-indexes-abort", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
