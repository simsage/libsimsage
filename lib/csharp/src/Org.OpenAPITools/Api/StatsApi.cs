...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IStatsApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organisationId">the organisation (its guid id)</param>
        /// <param name="service">the service to get the log for</param>
        /// <param name="numLines">the maximum number of lines to return if &gt; 0</param>
        /// <param name="sessionId">a valid SimSage Session id.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;CMLoggerEntry&gt;</returns>
        List<CMLoggerEntry> SystemLogs(string organisationId, string service, int numLines, string sessionId, int operationIndex = 0);
        ...
        ApiResponse<List<CMLoggerEntry>> SystemLogsWithHttpInfo(string organisationId, string service, int numLines, string sessionId, int operationIndex = 0);
        /// <summary>
        /// Version
        /// </summary>
        /// <remarks>
    ...
    public interface IStatsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<CMLoggerEntry>> SystemLogsAsync(string organisationId, string service, int numLines, string sessionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<CMLoggerEntry>>> SystemLogsWithHttpInfoAsync(string organisationId, string service, int numLines, string sessionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Version
        /// </summary>
        /// <remarks>
    ...
    public partial class StatsApi : IStatsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;CMLoggerEntry&gt;</returns>
        public List<CMLoggerEntry> SystemLogs(string organisationId, string service, int numLines, string sessionId, int operationIndex = 0)
        {
            Org.OpenAPITools.Client.ApiResponse<List<CMLoggerEntry>> localVarResponse = SystemLogsWithHttpInfo(organisationId, service, numLines, sessionId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;CMLoggerEntry&gt;</returns>
        public Org.OpenAPITools.Client.ApiResponse<List<CMLoggerEntry>> SystemLogsWithHttpInfo(string organisationId, string service, int numLines, string sessionId, int operationIndex = 0)
        {
            // verify the required parameter 'organisationId' is set
            if (organisationId == null)
            {
            ...
            if (service == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'service' when calling StatsApi->SystemLogs");
            }
            ...
            localVarRequestOptions.PathParameters.Add("organisationId", Org.OpenAPITools.Client.ClientUtils.ParameterToString(organisationId)); // path parameter
            localVarRequestOptions.PathParameters.Add("service", Org.OpenAPITools.Client.ClientUtils.ParameterToString(service)); // path parameter
            localVarRequestOptions.PathParameters.Add("numLines", Org.OpenAPITools.Client.ClientUtils.ParameterToString(numLines)); // path parameter
            localVarRequestOptions.HeaderParameters.Add("session-id", Org.OpenAPITools.Client.ClientUtils.ParameterToString(sessionId)); // header parameter
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<CMLoggerEntry>>("/api/stats/system-logs/{organisationId}/{service}/{numLines}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;CMLoggerEntry&gt;</returns>
        public async System.Threading.Tasks.Task<List<CMLoggerEntry>> SystemLogsAsync(string organisationId, string service, int numLines, string sessionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Org.OpenAPITools.Client.ApiResponse<List<CMLoggerEntry>> localVarResponse = await SystemLogsWithHttpInfoAsync(organisationId, service, numLines, sessionId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CMLoggerEntry&gt;)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<List<CMLoggerEntry>>> SystemLogsWithHttpInfoAsync(string organisationId, string service, int numLines, string sessionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'organisationId' is set
            if (organisationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<CMLoggerEntry>>("/api/stats/system-logs/{organisationId}/{service}/{numLines}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
