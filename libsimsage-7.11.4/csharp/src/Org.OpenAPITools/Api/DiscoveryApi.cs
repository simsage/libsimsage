...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class DiscoveryApi : IDiscoveryApi
    {
        ...
        public Org.OpenAPITools.Client.ApiResponse<Object> PdfBinaryWithHttpInfo(string organisationId, string kbId, string url, string? sessionId = default(string?), int operationIndex = 0)
        {
            ...
            if (organisationId == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'organisationId' when calling DiscoveryApi->PdfBinary");
            }

            // verify the required parameter 'kbId' is set
            if (kbId == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'kbId' when calling DiscoveryApi->PdfBinary");
            }

            // verify the required parameter 'url' is set
            if (url == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'url' when calling DiscoveryApi->PdfBinary");
            }
            ...
            localVarRequestOptions.Operation = "DiscoveryApi.PdfBinary";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/api/discovery/pdf/latest/{organisationId}/{kbId}/{url}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> PdfBinaryWithHttpInfoAsync(string organisationId, string kbId, string url, string? sessionId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/discovery/pdf/latest/{organisationId}/{kbId}/{url}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
