...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMNewComment : IEquatable<CMNewComment>, IValidatableObject
    {
        ...
        public CMNewComment(string organisationId = default(string), string projectId = default(string), string sliceId = default(string), string documentKey = default(string), string commentLevel = default(string), string comment = default(string))
        {
