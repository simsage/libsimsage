...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMRecordedComment : IEquatable<CMRecordedComment>, IValidatableObject
    {
        ...
        public CMRecordedComment(DateTime created = default(DateTime), string projectId = default(string), string sliceId = default(string), string documentKey = default(string), string commentLevel = default(string), string comment = default(string), string user = default(string))
        {
