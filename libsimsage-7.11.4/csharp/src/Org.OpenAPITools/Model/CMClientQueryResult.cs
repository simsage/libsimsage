...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMClientQueryResult : IEquatable<CMClientQueryResult>, IValidatableObject
    {
        ...
        /// <param name="assignedOperatorId">A unique id for this operator&#39;s session. (required).</param>
        /// <param name="operatorName">the name of the operator for clients (required).</param>
        ...
        public CMClientQueryResult(string messageType = default(string), string assignedOperatorId = default(string), string operatorName = default(string), string organisationId = default(string), string kbId = default(string), string text = default(string), bool hasResult = default(bool), List<string> urlList = default(List<string>), string metadata = default(string), float qnaScore = default(float), List<string> imageList = default(List<string>), int totalDocumentCount = default(int), List<int> shardSizeList = default(List<int>), List<CMSearchResult> resultList = default(List<CMSearchResult>), string spellingCorrection = default(string), Dictionary<string, List<CMWordFrequency>> semanticSet = default(Dictionary<string, List<CMWordFrequency>>), bool knowEmail = default(bool), List<SearchCategory> categoryList = default(List<SearchCategory>), List<CMSynSet> synSetList = default(List<CMSynSet>), bool customRender = default(bool), List<CMSavedSearch> savedSearchList = default(List<CMSavedSearch>), string querySummarization = default(string))
        {
            ...
            // to ensure "assignedOperatorId" is required (not null)
            if (assignedOperatorId == null)
            {
                throw new ArgumentNullException("assignedOperatorId is a required property for CMClientQueryResult and cannot be null");
            }
            this.AssignedOperatorId = assignedOperatorId;
            // to ensure "operatorName" is required (not null)
            if (operatorName == null)
            {
                throw new ArgumentNullException("operatorName is a required property for CMClientQueryResult and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A unique id for this operator&#39;s session.</value>
        /// <example>00000000-0000-0000-0000-000000000001</example>
        [DataMember(Name = "assignedOperatorId", IsRequired = true, EmitDefaultValue = true)]
        public string AssignedOperatorId { get; set; }

        /// <summary>
        /// the name of the operator for clients
        /// </summary>
        /// <value>the name of the operator for clients</value>
        /// <example>John</example>
        [DataMember(Name = "operatorName", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AssignedOperatorId: ").Append(AssignedOperatorId).Append("\n");
        ...
        public bool Equals(CMClientQueryResult input)
        {
            ...
            return 
                ...
                (
                    this.AssignedOperatorId == input.AssignedOperatorId ||
                    (this.AssignedOperatorId != null &&
                    this.AssignedOperatorId.Equals(input.AssignedOperatorId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AssignedOperatorId.GetHashCode();
                }
