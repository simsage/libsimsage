...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CMKnowledgeBaseInfo : IEquatable<CMKnowledgeBaseInfo>, IValidatableObject
    {
        ...
        public CMKnowledgeBaseInfo(string name = default(string), string id = default(string), List<SearchCategory> categoryList = default(List<SearchCategory>), List<CMSourceBaseInfo> sourceList = default(List<CMSourceBaseInfo>))
        {
