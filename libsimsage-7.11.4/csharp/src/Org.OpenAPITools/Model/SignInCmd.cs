...
namespace Org.OpenAPITools.Model
{
    ...
    /// SignInCmd
    /// </summary>
    [DataContract(Name = "SignInCmd")]
    public partial class SignInCmd : IEquatable<SignInCmd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignInCmd" /> class.
        /// </summary>
        ...
        public SignInCmd(string jobId = default(string), string returnAddress = default(string), string errorStr = default(string), long timeOut = default(long), bool async = default(bool), bool isReturnResult = default(bool), string email = default(string), string password = default(string), List<string> roles = default(List<string>), string remoteAddress = default(string), Session session = default(Session), User user = default(User), string organisationId = default(string), List<Organisation> organisationList = default(List<Organisation>), bool returnResult = default(bool))
        {
            // to ensure "jobId" is required (not null)
            if (jobId == null)
            {
                throw new ArgumentNullException("jobId is a required property for SignInCmd and cannot be null");
            }
            this.JobId = jobId;
            // to ensure "returnAddress" is required (not null)
            if (returnAddress == null)
            {
                throw new ArgumentNullException("returnAddress is a required property for SignInCmd and cannot be null");
            }
            this.ReturnAddress = returnAddress;
            // to ensure "errorStr" is required (not null)
            if (errorStr == null)
            {
                throw new ArgumentNullException("errorStr is a required property for SignInCmd and cannot be null");
            }
            ...
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for SignInCmd and cannot be null");
            }
            this.Email = email;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for SignInCmd and cannot be null");
            }
            this.Password = password;
            // to ensure "roles" is required (not null)
            if (roles == null)
            {
                throw new ArgumentNullException("roles is a required property for SignInCmd and cannot be null");
            }
            this.Roles = roles;
            // to ensure "remoteAddress" is required (not null)
            if (remoteAddress == null)
            {
                throw new ArgumentNullException("remoteAddress is a required property for SignInCmd and cannot be null");
            }
            this.RemoteAddress = remoteAddress;
            // to ensure "session" is required (not null)
            if (session == null)
            {
                throw new ArgumentNullException("session is a required property for SignInCmd and cannot be null");
            }
            this.Session = session;
            // to ensure "user" is required (not null)
            if (user == null)
            {
                throw new ArgumentNullException("user is a required property for SignInCmd and cannot be null");
            }
            this.User = user;
            // to ensure "organisationId" is required (not null)
            if (organisationId == null)
            {
                throw new ArgumentNullException("organisationId is a required property for SignInCmd and cannot be null");
            }
            this.OrganisationId = organisationId;
            // to ensure "organisationList" is required (not null)
            if (organisationList == null)
            {
                throw new ArgumentNullException("organisationList is a required property for SignInCmd and cannot be null");
            }
        ...
        {
            return this.Equals(input as SignInCmd);
        }

        /// <summary>
        /// Returns true if SignInCmd instances are equal
        /// </summary>
        /// <param name="input">Instance of SignInCmd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignInCmd input)
        {
            if (input == null)
            {
                return false;
