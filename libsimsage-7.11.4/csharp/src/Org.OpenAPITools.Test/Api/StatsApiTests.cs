...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public class StatsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GetIndexOptimzationReport
        /// </summary>
        [Fact]
        public void GetIndexOptimzationReportTest()
        {
            ...
            //string kbId = null;
            //long id = null;
            //var response = instance.GetIndexOptimzationReport(sessionId, organisationId, kbId, id);
            //Assert.IsType<List<OptimizeIndexesGetReportCmd>>(response);
        }

        /// <summary>
        /// Test GetIndexOptimzationReports
        /// </summary>
        [Fact]
        public void GetIndexOptimzationReportsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string sessionId = null;
            //string organisationId = null;
            //string kbId = null;
            //var response = instance.GetIndexOptimzationReports(sessionId, organisationId, kbId);
