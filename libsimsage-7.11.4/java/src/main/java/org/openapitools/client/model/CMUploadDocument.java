...
public class CMUploadDocument {
  ...
  private List<MDCategory> categories = new ArrayList<>();
  ...
  **/
  ...
  public CMUploadDocument categories(List<MDCategory> categories) {
    
    this.categories = categories;
    return this;
  }

  public CMUploadDocument addCategoriesItem(MDCategory categoriesItem) {
  ...
  **/
  ...
  public CMUploadDocument runId(String runId) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraycategories.size(); i++) {
        MDCategory.validateJsonElement(jsonArraycategories.get(i));
      };
