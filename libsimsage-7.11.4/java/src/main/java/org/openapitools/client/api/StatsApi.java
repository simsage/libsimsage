...
public class StatsApi {
    ...
    /**
     * Build call for getIndexOptimzationReport
     ...
     */
    public okhttp3.Call getIndexOptimzationReportCall(String sessionId, String organisationId, String kbId, Long id, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getIndexOptimzationReportValidateBeforeCall(String sessionId, String organisationId, String kbId, Long id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
            throw new ApiException("Missing the required parameter 'sessionId' when calling getIndexOptimzationReport(Async)");
        }

        // verify the required parameter 'organisationId' is set
        if (organisationId == null) {
            throw new ApiException("Missing the required parameter 'organisationId' when calling getIndexOptimzationReport(Async)");
        }

        // verify the required parameter 'kbId' is set
        if (kbId == null) {
            throw new ApiException("Missing the required parameter 'kbId' when calling getIndexOptimzationReport(Async)");
        }

        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getIndexOptimzationReport(Async)");
        }

        return getIndexOptimzationReportCall(sessionId, organisationId, kbId, id, _callback);
     ...
     */
    public List<OptimizeIndexesGetReportCmd> getIndexOptimzationReport(String sessionId, String organisationId, String kbId, Long id) throws ApiException {
        ApiResponse<List<OptimizeIndexesGetReportCmd>> localVarResp = getIndexOptimzationReportWithHttpInfo(sessionId, organisationId, kbId, id);
     ...
     */
    public ApiResponse<List<OptimizeIndexesGetReportCmd>> getIndexOptimzationReportWithHttpInfo(String sessionId, String organisationId, String kbId, Long id) throws ApiException {
        okhttp3.Call localVarCall = getIndexOptimzationReportValidateBeforeCall(sessionId, organisationId, kbId, id, null);
     ...
     */
    public okhttp3.Call getIndexOptimzationReportAsync(String sessionId, String organisationId, String kbId, Long id, final ApiCallback<List<OptimizeIndexesGetReportCmd>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIndexOptimzationReportValidateBeforeCall(sessionId, organisationId, kbId, id, _callback);
        Type localVarReturnType = new TypeToken<List<OptimizeIndexesGetReportCmd>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getIndexOptimzationReports
     * @param sessionId a valid session-guid id. (required)
     * @param organisationId the organisation (its guid id) (required)
     * @param kbId the knowledge-base (its guid id) (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getIndexOptimzationReportsCall(String sessionId, String organisationId, String kbId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getIndexOptimzationReportsValidateBeforeCall(String sessionId, String organisationId, String kbId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sessionId' is set
        if (sessionId == null) {
            throw new ApiException("Missing the required parameter 'sessionId' when calling getIndexOptimzationReports(Async)");
        }

        // verify the required parameter 'organisationId' is set
        if (organisationId == null) {
            throw new ApiException("Missing the required parameter 'organisationId' when calling getIndexOptimzationReports(Async)");
        }

        // verify the required parameter 'kbId' is set
        if (kbId == null) {
            throw new ApiException("Missing the required parameter 'kbId' when calling getIndexOptimzationReports(Async)");
        }

        return getIndexOptimzationReportsCall(sessionId, organisationId, kbId, _callback);
     ...
     */
    public List<OptimizeIndexesGetReportsCmd> getIndexOptimzationReports(String sessionId, String organisationId, String kbId) throws ApiException {
        ApiResponse<List<OptimizeIndexesGetReportsCmd>> localVarResp = getIndexOptimzationReportsWithHttpInfo(sessionId, organisationId, kbId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<OptimizeIndexesGetReportsCmd>> getIndexOptimzationReportsWithHttpInfo(String sessionId, String organisationId, String kbId) throws ApiException {
        okhttp3.Call localVarCall = getIndexOptimzationReportsValidateBeforeCall(sessionId, organisationId, kbId, null);
     ...
     */
    public okhttp3.Call getIndexOptimzationReportsAsync(String sessionId, String organisationId, String kbId, final ApiCallback<List<OptimizeIndexesGetReportsCmd>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIndexOptimzationReportsValidateBeforeCall(sessionId, organisationId, kbId, _callback);
        Type localVarReturnType = new TypeToken<List<OptimizeIndexesGetReportsCmd>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
