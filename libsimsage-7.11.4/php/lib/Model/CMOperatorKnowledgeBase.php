...
/**
 * CMOperatorKnowledgeBase Class Doc Comment
 *
 * @category Class
 ...
 */
class CMOperatorKnowledgeBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMOperatorKnowledgeBase';
    ...
    */
     ...
     * Sets user_id
     *
     * @param string $user_id the user's id (its guid id) that is an operator
     *
     * @return self
     */
     ...
     *
     * @param string $organisation_id the organisation (its guid id) this operator applies to
     *
     * @return self
     */
     ...
     * Sets kb_id
     *
     * @param string $kb_id the knowledge-base (its guid id) this operator applies to
     *
     * @return self
     */
