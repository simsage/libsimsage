...
class CMUploadDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'categories' => '\OpenAPI\Client\Model\MDCategory[]',
        'size' => 'int',
        'template' => 'string',
        'encrypted' => 'bool',
        'seed' => 'int',
    ...
    */
     ...
     * Gets categories
     *
     * @return \OpenAPI\Client\Model\MDCategory[]
     */
     ...
     * Sets categories
     *
     * @param \OpenAPI\Client\Model\MDCategory[] $categories A list of special SimSage metadata categories for matching this document with.  Can be empty.
     *
     * @return self
     */
     ...
     * Sets run_id
     *
     * @param string $run_id the id (a guid) of the current 'go through the source once'.  This is a unique per-run identifier.
     *
     * @return self
     */
