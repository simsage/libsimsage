...
/**
 * CMTextToSearchPaginated Class Doc Comment
 *
 * @category Class
 ...
 */
class CMTextToSearchPaginated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CMTextToSearchPaginated';
    ...
    */
     ...
     * Sets prev_word
     *
     * @param string $prev_word pagination control, the last text-to-search word we looked for previously
     *
     * @return self
     */
     ...
     * Sets page_size
     *
     * @param int $page_size the number of text-to-search to return at a time.
     *
     * @return self
     */
     ...
     * Sets filter
     *
     * @param string $filter An optional string filter to apply to all text-to-search in the search.  Can be empty in which case SimSage will return all semantics paginated.
     *
     * @return self
     */
