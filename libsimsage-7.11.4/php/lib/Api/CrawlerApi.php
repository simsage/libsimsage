...
/**
    ...
    /**
     * Operation crawlerExternalDocumentUnChanged
     *
     * Mark External Document Unchanged
     *
     * @param  \OpenAPI\Client\Model\CMDocumentUnChanged $cm_document_un_changed cm_document_un_changed (required)
     * @param  string $api_version api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['crawlerExternalDocumentUnChanged'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\JsonMessage
     */
    public function crawlerExternalDocumentUnChanged($cm_document_un_changed, $api_version = null, string $contentType = self::contentTypes['crawlerExternalDocumentUnChanged'][0])
    {
        list($response) = $this->crawlerExternalDocumentUnChangedWithHttpInfo($cm_document_un_changed, $api_version, $contentType);
        return $response;
    }

    /**
     * Operation crawlerExternalDocumentUnChangedWithHttpInfo
     *
     * Mark External Document Unchanged
     *
     * @param  \OpenAPI\Client\Model\CMDocumentUnChanged $cm_document_un_changed (required)
     * @param  string $api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['crawlerExternalDocumentUnChanged'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     ...
     * @return array of \OpenAPI\Client\Model\JsonMessage|\OpenAPI\Client\Model\JsonMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function crawlerExternalDocumentUnChangedWithHttpInfo($cm_document_un_changed, $api_version = null, string $contentType = self::contentTypes['crawlerExternalDocumentUnChanged'][0])
    {
        $request = $this->crawlerExternalDocumentUnChangedRequest($cm_document_un_changed, $api_version, $contentType);
    ...
    /**
     * Operation crawlerExternalDocumentUnChangedAsync
     *
     * Mark External Document Unchanged
     *
     * @param  \OpenAPI\Client\Model\CMDocumentUnChanged $cm_document_un_changed (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crawlerExternalDocumentUnChangedAsync($cm_document_un_changed, $api_version = null, string $contentType = self::contentTypes['crawlerExternalDocumentUnChanged'][0])
    {
        return $this->crawlerExternalDocumentUnChangedAsyncWithHttpInfo($cm_document_un_changed, $api_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation crawlerExternalDocumentUnChangedAsyncWithHttpInfo
     *
     * Mark External Document Unchanged
     *
     * @param  \OpenAPI\Client\Model\CMDocumentUnChanged $cm_document_un_changed (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function crawlerExternalDocumentUnChangedAsyncWithHttpInfo($cm_document_un_changed, $api_version = null, string $contentType = self::contentTypes['crawlerExternalDocumentUnChanged'][0])
    {
        $returnType = '\OpenAPI\Client\Model\JsonMessage';
        $request = $this->crawlerExternalDocumentUnChangedRequest($cm_document_un_changed, $api_version, $contentType);
    ...
    /**
     * Create request for operation 'crawlerExternalDocumentUnChanged'
     *
     * @param  \OpenAPI\Client\Model\CMDocumentUnChanged $cm_document_un_changed (required)
     * @param  string $api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['crawlerExternalDocumentUnChanged'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function crawlerExternalDocumentUnChangedRequest($cm_document_un_changed, $api_version = null, string $contentType = self::contentTypes['crawlerExternalDocumentUnChanged'][0])
    {

        // verify the required parameter 'cm_document_un_changed' is set
        if ($cm_document_un_changed === null || (is_array($cm_document_un_changed) && count($cm_document_un_changed) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cm_document_un_changed when calling crawlerExternalDocumentUnChanged'
            );
        }



        $resourcePath = '/api/crawler/external/document/un-changed';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($cm_document_un_changed)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cm_document_un_changed));
            } else {
                $httpBody = $cm_document_un_changed;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
