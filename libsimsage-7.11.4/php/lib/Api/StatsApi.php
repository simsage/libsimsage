...
/**
    ...
    /**
     * Operation getIndexOptimzationReport
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIndexOptimzationReport'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\OptimizeIndexesGetReportCmd[]|\OpenAPI\Client\Model\JsonMessage
     */
    public function getIndexOptimzationReport($session_id, $organisation_id, $kb_id, $id, string $contentType = self::contentTypes['getIndexOptimzationReport'][0])
    {
        list($response) = $this->getIndexOptimzationReportWithHttpInfo($session_id, $organisation_id, $kb_id, $id, $contentType);
        return $response;
    }

    /**
     * Operation getIndexOptimzationReportWithHttpInfo
     *
     * get an optimization report
     *
     * @param  string $session_id a valid session-guid id. (required)
     ...
     */
    public function getIndexOptimzationReportWithHttpInfo($session_id, $organisation_id, $kb_id, $id, string $contentType = self::contentTypes['getIndexOptimzationReport'][0])
    {
        $request = $this->getIndexOptimzationReportRequest($session_id, $organisation_id, $kb_id, $id, $contentType);
    ...
    /**
     * Operation getIndexOptimzationReportAsync
     *
     * get an optimization report
     *
     * @param  string $session_id a valid session-guid id. (required)
     ...
     */
    public function getIndexOptimzationReportAsync($session_id, $organisation_id, $kb_id, $id, string $contentType = self::contentTypes['getIndexOptimzationReport'][0])
    {
        return $this->getIndexOptimzationReportAsyncWithHttpInfo($session_id, $organisation_id, $kb_id, $id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getIndexOptimzationReportAsyncWithHttpInfo
     *
     * get an optimization report
     *
     * @param  string $session_id a valid session-guid id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndexOptimzationReportAsyncWithHttpInfo($session_id, $organisation_id, $kb_id, $id, string $contentType = self::contentTypes['getIndexOptimzationReport'][0])
    {
        $returnType = '\OpenAPI\Client\Model\OptimizeIndexesGetReportCmd[]';
        $request = $this->getIndexOptimzationReportRequest($session_id, $organisation_id, $kb_id, $id, $contentType);
    ...
    /**
     * Create request for operation 'getIndexOptimzationReport'
     *
     * @param  string $session_id a valid session-guid id. (required)
     * @param  string $organisation_id the organisation (its guid id) (required)
     * @param  string $kb_id the knowledge-base (its guid id) (required)
     ...
     */
    public function getIndexOptimzationReportRequest($session_id, $organisation_id, $kb_id, $id, string $contentType = self::contentTypes['getIndexOptimzationReport'][0])
    {

        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling getIndexOptimzationReport'
            );
        }
        ...
        if ($organisation_id === null || (is_array($organisation_id) && count($organisation_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organisation_id when calling getIndexOptimzationReport'
            );
        }
        ...
        if ($kb_id === null || (is_array($kb_id) && count($kb_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $kb_id when calling getIndexOptimzationReport'
            );
        }
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getIndexOptimzationReport'
            );
        }
    ...
    /**
     * Operation getIndexOptimzationReports
     *
     ...
     * @param  string $organisation_id the organisation (its guid id) (required)
     * @param  string $kb_id the knowledge-base (its guid id) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIndexOptimzationReports'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\OptimizeIndexesGetReportsCmd[]|\OpenAPI\Client\Model\JsonMessage
     */
    public function getIndexOptimzationReports($session_id, $organisation_id, $kb_id, string $contentType = self::contentTypes['getIndexOptimzationReports'][0])
    {
        list($response) = $this->getIndexOptimzationReportsWithHttpInfo($session_id, $organisation_id, $kb_id, $contentType);
        return $response;
    }

    /**
     * Operation getIndexOptimzationReportsWithHttpInfo
     *
     * get optimization report list
     *
     * @param  string $session_id a valid session-guid id. (required)
     ...
     */
    public function getIndexOptimzationReportsWithHttpInfo($session_id, $organisation_id, $kb_id, string $contentType = self::contentTypes['getIndexOptimzationReports'][0])
    {
        $request = $this->getIndexOptimzationReportsRequest($session_id, $organisation_id, $kb_id, $contentType);
    ...
    /**
     * Operation getIndexOptimzationReportsAsync
     *
     * get optimization report list
     *
     * @param  string $session_id a valid session-guid id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndexOptimzationReportsAsync($session_id, $organisation_id, $kb_id, string $contentType = self::contentTypes['getIndexOptimzationReports'][0])
    {
        return $this->getIndexOptimzationReportsAsyncWithHttpInfo($session_id, $organisation_id, $kb_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getIndexOptimzationReportsAsyncWithHttpInfo
     *
     * get optimization report list
     *
     * @param  string $session_id a valid session-guid id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndexOptimzationReportsAsyncWithHttpInfo($session_id, $organisation_id, $kb_id, string $contentType = self::contentTypes['getIndexOptimzationReports'][0])
    {
        $returnType = '\OpenAPI\Client\Model\OptimizeIndexesGetReportsCmd[]';
        $request = $this->getIndexOptimzationReportsRequest($session_id, $organisation_id, $kb_id, $contentType);
    ...
    /**
     * Create request for operation 'getIndexOptimzationReports'
     *
     * @param  string $session_id a valid session-guid id. (required)
     * @param  string $organisation_id the organisation (its guid id) (required)
     * @param  string $kb_id the knowledge-base (its guid id) (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIndexOptimzationReportsRequest($session_id, $organisation_id, $kb_id, string $contentType = self::contentTypes['getIndexOptimzationReports'][0])
    {

        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling getIndexOptimzationReports'
            );
        }
        ...
        if ($organisation_id === null || (is_array($organisation_id) && count($organisation_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organisation_id when calling getIndexOptimzationReports'
            );
        }
        ...
        if ($kb_id === null || (is_array($kb_id) && count($kb_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $kb_id when calling getIndexOptimzationReports'
            );
        }
     ...
     *
     * @param  string $organisation_id the organisation (its guid id) (required)
     * @param  int $year the year to get the log for (required)
     * @param  int $month the month to get the log for (required)
     * @param  int $day the day to get the log for (required)
     * @param  int $hour the hour to get the log for (required)
     * @param  int $hours the number of hours to get the logs for starting at hour (required)
     * @param  string $session_id a valid SimSage Session id. (required)
     ...
     */
    public function systemLogs($organisation_id, $year, $month, $day, $hour, $hours, $session_id, string $contentType = self::contentTypes['systemLogs'][0])
    {
        list($response) = $this->systemLogsWithHttpInfo($organisation_id, $year, $month, $day, $hour, $hours, $session_id, $contentType);
        return $response;
    }
     ...
     */
    public function systemLogsWithHttpInfo($organisation_id, $year, $month, $day, $hour, $hours, $session_id, string $contentType = self::contentTypes['systemLogs'][0])
    {
        $request = $this->systemLogsRequest($organisation_id, $year, $month, $day, $hour, $hours, $session_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemLogsAsync($organisation_id, $year, $month, $day, $hour, $hours, $session_id, string $contentType = self::contentTypes['systemLogs'][0])
    {
        return $this->systemLogsAsyncWithHttpInfo($organisation_id, $year, $month, $day, $hour, $hours, $session_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function systemLogsAsyncWithHttpInfo($organisation_id, $year, $month, $day, $hour, $hours, $session_id, string $contentType = self::contentTypes['systemLogs'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CMLoggerEntry[]';
        $request = $this->systemLogsRequest($organisation_id, $year, $month, $day, $hour, $hours, $session_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function systemLogsRequest($organisation_id, $year, $month, $day, $hour, $hours, $session_id, string $contentType = self::contentTypes['systemLogs'][0])
    {
        ...
        if ($year === null || (is_array($year) && count($year) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $year when calling systemLogs'
            );
        }
        ...
        if ($month === null || (is_array($month) && count($month) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $month when calling systemLogs'
            );
        }
        ...
        if ($day === null || (is_array($day) && count($day) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $day when calling systemLogs'
            );
        }
        ...
        if ($hour === null || (is_array($hour) && count($hour) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hour when calling systemLogs'
            );
        }
        ...
        if ($hours === null || (is_array($hours) && count($hours) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hours when calling systemLogs'
            );
        }
        ...
        $resourcePath = '/api/stats/system-logs/{organisationId}/{year}/{month}/{day}/{hour}/{hours}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($hour !== null) {
            $resourcePath = str_replace(
                '{' . 'hour' . '}',
                ObjectSerializer::toPathValue($hour),
                $resourcePath
            );
        }
        // path params
        if ($hours !== null) {
            $resourcePath = str_replace(
                '{' . 'hours' . '}',
                ObjectSerializer::toPathValue($hours),
                $resourcePath
            );
        }
