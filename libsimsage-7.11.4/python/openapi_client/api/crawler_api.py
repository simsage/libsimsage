...
class CrawlerApi:
    ...
    @validate_arguments
    def crawler_external_document_un_changed(self, cm_document_un_changed : CMDocumentUnChanged, api_version : Optional[StrictStr] = None, **kwargs) -> JsonMessage:  # noqa: E501
        """Mark External Document Unchanged  # noqa: E501

        An external crawler document marks a document as not having changed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.crawler_external_document_un_changed(cm_document_un_changed, api_version, async_req=True)
        >>> result = thread.get()

        :param cm_document_un_changed: (required)
        :type cm_document_un_changed: CMDocumentUnChanged
        :param api_version:
        :type api_version: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the crawler_external_document_un_changed_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.crawler_external_document_un_changed_with_http_info(cm_document_un_changed, api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def crawler_external_document_un_changed_with_http_info(self, cm_document_un_changed : CMDocumentUnChanged, api_version : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Mark External Document Unchanged  # noqa: E501
        ...
        >>> thread = api.crawler_external_document_un_changed_with_http_info(cm_document_un_changed, api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method crawler_external_document_un_changed" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['cm_document_un_changed'] is not None:
            _body_params = _params['cm_document_un_changed']
        ...
        return self.api_client.call_api(
            '/api/crawler/external/document/un-changed', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
