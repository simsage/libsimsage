...
class CMZipSource(BaseModel):
    """
    a zip source model  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CMZipSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CMZipSource:
        """Create an instance of CMZipSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CMZipSource.parse_obj(obj)

        _obj = CMZipSource.parse_obj({
