...
| **oldFolderNameUrl** | **String** | the current document-folder name | [default to null] |
| **newFolderNameUrl** | **String** | the new document-folder name | [default to null] |
| **acls** | **String** | A list of security permission for the new document-folder.  Can be empty (ie. no security applied). | [default to null] |
